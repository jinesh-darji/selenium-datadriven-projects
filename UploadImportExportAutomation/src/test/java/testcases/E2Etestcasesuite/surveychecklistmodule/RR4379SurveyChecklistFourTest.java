...
public class RR4379SurveyChecklistFourTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR4379SurveyChecklistFourTest(Hashtable<String, String> data) throws InterruptedException, IOException {

		execution(data, "rR4379SurveyChecklistFourTest");

		// SURVEY WORKFLOW NOTIFICATION SHOULD FILTER COMPLETED SURVEY WHEN SENDING TO
		// "EDITORS - INCOMPLETE QUESTIONNAIRES" - An incomplete properties has to be
		// displayed in the email and completed properties has to be not displayed in
		// the email.

		System.out.println(
				"SURVEY WORKFLOW NOTIFICATION SHOULD FILTER COMPLETED SURVEY WHEN SENDING TO \"EDITORS - INCOMPLETE QUESTIONNAIRES\" - "
						+ "only incomplete properties has to be displayed in the email and completed properties has to be not displayed in the email.");
		...
		try {
			...
			try {
				...
				switchVerification("workflowsecurity_filteredsurveynotification_createdrecord_3_XPATH",
						"Test Filtered Survey Notification Workflow Four Security",
						"The Test Filtered Survey Notification Workflow Four Security is not displayed.");

				// ADD CATEGORY 1 INTO THE QUESTIONNAIRE

				// click on the created questionnaire
				click("workflowsecurity_filteredsurveynotification_createdrecord_3_XPATH");
			...
			try {
				...
				// click on the yes button of the first question of the first category
				click("survey_yesanswerbtn_1_CSS");
				System.out.println("Clicked on the yes button of the first question of the first category.");
				ngDriver.waitForAngularRequestsToFinish();
			...
			try {
				...
				try {
					String str1 = driver
							.findElement(
									By.xpath(OR.getProperty("workflowsecurity_sendnotification_recipienttxt_XPATH")))
							.getText();
					ngDriver.waitForAngularRequestsToFinish();
					if (str1.equals("Jinesh")) {

						switchVerification("workflowsecurity_sendnotification_recipienttxt_XPATH", "Jinesh",
								"The filtered user is not displayed.");

						System.out.println("The filtered user is displayed correctly.");
						test.log(LogStatus.INFO, "The filtered user is displayed correctly.");
						Reporter.log("The filtered user is displayed correctly.");
						log.info("The filtered user is displayed correctly.");
					} else {
						TestUtil.captureScreenshot();

						// ReportNG
						Reporter.log("<br>" + "The filtered user is not displayed correctly : " + "<br>");
						...
						// Extent Report
						test.log(LogStatus.FAIL, " The filtered user is not displayed correctly : ");
						test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));

						System.out.println("The filtered user is not displayed correctly.");
						log.info("The filtered user is not displayed correctly.");
					}
				} catch (Throwable t) {
					TestUtil.captureScreenshot();
				...
				// enter data in the subject field
				type("workflowsecurity_sendnotification_subjecttxt_CSS", data.get("subject"));
				System.out.println("Entered data in the subject field.");
				ngDriver.waitForAngularRequestsToFinish();

				// enter data in message field
				type("workflowsecurity_sendnotification_messagetxt_CSS", data.get("message"));
				System.out.println("Entered data in message field.");
				ngDriver.waitForAngularRequestsToFinish();

				// click on the send button
				click("workflowsecurity_sendnotification_sendbtn_CSS");

...
public class RR4379SurveyChecklistTwoTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR4379SurveyChecklistTwoTest(Hashtable<String, String> data) throws InterruptedException, IOException {

		execution(data, "rR4379SurveyChecklistTwoTest");

		// SURVEY WORKFLOW NOTIFICATION SHOULD FILTER COMPLETED SURVEY WHEN SENDING TO
		// "EDITORS - INCOMPLETE QUESTIONNAIRES" - If no incomplete survey then no mail
		// has to be sent out to the User

		System.out.println(
				"SURVEY WORKFLOW NOTIFICATION SHOULD FILTER COMPLETED SURVEY WHEN SENDING TO \"EDITORS - INCOMPLETE QUESTIONNAIRES\" - If no incomplete survey then no mail has to be sent out to the User.");
		...
		try {
			...
			try {
				...
				switchVerification("workflowsecurity_filteredsurveynotification_createdrecord_1_XPATH",
						"Test Filtered Survey Notification Workflow Two Security",
						"The Test Filtered Survey Notification Workflow Two Security is not displayed.");

				// CONFIGRATION OF QUESTION

				// click on the created questionnaire
				click("workflowsecurity_filteredsurveynotification_createdrecord_1_XPATH");
...
//		}
				...
				// click on the select user field of the editor tasks section
				click("workflowsecurity_sendnotification_recipienttxt_CSS");
				System.out.println("Clicked on the select user field of the editor tasks section.");
				ngDriver.waitForAngularRequestsToFinish();
				...
				// Enter data in the find user field
				type("workflowsecurity_sendnotification_recipientsearch_CSS", data.get("task_find_user"));
				System.out.println("The data entered in the find user field.");
				ngDriver.waitForAngularRequestsToFinish();

...
public class RR4379SurveyChecklistOneTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR4379SurveyChecklistOneTest(Hashtable<String, String> data) throws InterruptedException, IOException {

		execution(data, "rR4379SurveyChecklistOneTest");

		// SURVEY WORKFLOW NOTIFICATION SHOULD FILTER COMPLETED SURVEY WHEN SENDING TO
		// "EDITORS - INCOMPLETE QUESTIONNAIRES" - only incomplete properties has to be
		// displayed in the email.

		System.out.println(
				"SURVEY WORKFLOW NOTIFICATION SHOULD FILTER COMPLETED SURVEY WHEN SENDING TO \"EDITORS - INCOMPLETE QUESTIONNAIRES\" - only incomplete properties has to be displayed in the email.");
		...
		try {
			...
			try {
				...
				switchVerification("workflowsecurity_filteredsurveynotification_createdrecord_XPATH",
						"Test Filtered Survey Notification Workflow One Security",
						"The Test Filtered Survey Notification Workflow One Security is not displayed.");

				// ADD CATEGORY 1 INTO THE QUESTIONNAIRE

				// click on the created questionnaire
				click("workflowsecurity_filteredsurveynotification_createdrecord_XPATH");
			...
			try {
				...
				try {
					...
					// ReportNG
					Reporter.log("<br>" + "The filtered user is displayed correctly : " + "<br>");
					Reporter.log("<a target=\"_blank\" href=" + TestUtil.screenshotName + "><img src="
							+ TestUtil.screenshotName + " height=200 width=200></img></a>");
					Reporter.log("<br>");
					Reporter.log("<br>");
					...
					// Extent Report
					test.log(LogStatus.FAIL, " The filtered user is displayed correctly : ");
					test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));

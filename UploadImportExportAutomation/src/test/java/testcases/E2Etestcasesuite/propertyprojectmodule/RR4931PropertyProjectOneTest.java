...
public class RR4931PropertyProjectOneTest extends TestBase {
	...
	public void rR4931PropertyProjectOneTest(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		title("APPLY THE \\\"PERMISSION TO DOWNLOAD TASK ATTACHMENTS\\\" SECURITY SETTINGS TO THE ATTACHMENT FOR THE REPAIR (TASK).");
		...
		try {
			...
			try {
				...
				if (downloadbtn3 == true) {
					...
					verificationFailedMessage("The Download button is displayed without the permission.");
				} else {

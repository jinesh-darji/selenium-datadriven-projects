...
public class RR4931PropertyProjectThreeTest extends TestBase {
	...
	public void rR4931PropertyProjectThreeTest(Hashtable<String, String> data)
		...
		title("APPLY THE \\\"PERMISSION TO MODIFY TASK ATTACHMENTS\\\" SECURITY SETTINGS TO THE ATTACHMENT FOR THE REPAIR (TASK).");
		...
		try {
			...
			try {
				...
				if (str1.equals("sample.pdf")) {
					...
					verificationFailedMessage("The uploaded file is not displayed.");
				}
		...
		try {
			...
			title("VERIFY THE PERMISSION TO MODIFY TASK ATTACHMENTS IN THE JINESH USER");
			...
			try {
				...
				if (uploadButton1 == true) {
					successMessage("The user able to access the Upload Local File Button as expected.");
				} else {
					verificationFailedMessage("The user not able to access the Upload Local File Button.");
				}
			...
			try {
				...
				if (downloadbtn1 == true) {
					successMessage("The Download button is displayed as expected.");
				} else {
					verificationFailedMessage("The Download button is not displayed.");
				}
			...
			title("VERIFY THE PERMISSION TO MODIFY TASK ATTACHMENTS IN THE JINESH CONTRACTOR");
			...
			try {
				...
				verificationFailedMessage("The user able to access the Upload Local File Button without permission.");
			}
			...
			title("VERIFY THE PERMISSION TO MODIFY TASK ATTACHMENTS IN THE JINESH HR");
			...
			try {
				...
				if (uploadButton3 == true) {
					...
					successMessage("The user not able to access the Upload Local File Button as expected.");
				}
			...
			try {
				...
				if (downloadbtn3 == true) {
					verificationFailedMessage("The Download button is displayed.");
				} else {
					successMessage("The Download button is not displayed as expected.");
				}

...
public class RR4931PropertyProjectThreeTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR4931PropertyProjectThreeTest(Hashtable<String, String> data)
			throws IOException, InterruptedException {

		execution(data, "rR4931PropertyProjectThreeTest");

		// APPLY THE "PERMISSION TO MODIFY TASK ATTACHMENTS" SECURITY SETTINGS TO
		// THE ATTACHMENT FOR THE REPAIR (TASK)

		System.out.println(
				"APPLY THE \"PERMISSION TO MODIFY TASK ATTACHMENTS\" SECURITY SETTINGS TO THE ATTACHMENT FOR THE REPAIR (TASK).");
		...
		try {
			...
			// APPLY THE PERMISSION TO MODIFY TASK ATTACHMENTS

			helper.addPermissionOneUsersRole(data, "security_setting_attachment_3",
...
//			uploadFile(System.getProperty("user.dir") + "\\src\\test\\resources\\logs\\sample.pdf");
				...
				if (str1.equals("sample.pdf")) {
					...
					Assert.assertTrue(
							isElementPresent(By.xpath(OR.getProperty("propertyproject_mu_attchedfilename_XPATH"))),
			...
			// wait for the element
			explicitWaitClickable("propertyproject_mu_addedrepair_attachment3_XPATH");

			// verify newly created repair is displayed or not
			switchVerification("propertyproject_mu_addedrepair_attachment3_XPATH",
					"Test SS Attachment 3 Mortgage Undertakings Title",
					"The Test SS Attachment 3 Mortgage Undertakings Title is not displayed.");
			...
			// wait for the element
			explicitWaitClickable("propertyproject_mu_addedmortgageundertakings_attachment3_XPATH");

			// verify newly created mortgage undertaking is displayed or not
			switchVerification("propertyproject_mu_addedmortgageundertakings_attachment3_XPATH",
					"UNDERTAKINGSSATTACHMENTTHREE2021", "The UNDERTAKINGSSATTACHMENTTHREE2021 is not displayed.");
		...
		try {
			// VERIFY THE PERMISSION TO MODIFY TASK ATTACHMENTS IN THE JINESH USER
			...
			click("propertyproject_mu_addedmortgageundertakings_attachment3_XPATH");
			ngDriver.waitForAngularRequestsToFinish();
			...
			click("propertyproject_mu_addedrepair_attachment3_XPATH");
			ngDriver.waitForAngularRequestsToFinish();
			...
			try {
				...
				// verify upload local file button is displayed or not
				boolean uploadButton1 = driver
						.findElement(
								By.cssSelector(OR.getProperty("task_addtask_attachmentstab_uploadlocalfilebtn_CSS")))
						.isDisplayed();

				if (uploadButton1 == true) {

					System.out.println("The user able to access the Upload Local File Button as expected.");
					test.log(LogStatus.INFO, "The user able to access the Upload Local File Button as expected.");
					Reporter.log("The user able to access the Upload Local File Button as expected.");
					log.info("The user able to access the Upload Local File Button as expected.");

				} else {
					TestUtil.captureScreenshot();

					// ReportNG
					Reporter.log("<br>" + "The user not able to access the Upload Local File Button : " + "<br>");
					Reporter.log("<a target=\"_blank\" href=" + TestUtil.screenshotName + "><img src="
							+ TestUtil.screenshotName + " height=200 width=200></img></a>");
					Reporter.log("<br>");
					Reporter.log("<br>");
					...
					// Extent Report
					test.log(LogStatus.FAIL, " The user not able to access the Upload Local File Button : ");
					test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));

					System.out.println("The user not able to access the Upload Local File Button");
					log.info("The user not able to access the Upload Local File Button");
				}
			...
			// VERIFY THE PERMISSION TO MODIFY TASK ATTACHMENTS IN THE JINESH CONTRACTOR
			...
			try {
				...
				// verify upload local file button is displayed or not
				boolean uploadButton2 = driver
						.findElement(
								By.cssSelector(OR.getProperty("task_addtask_attachmentstab_uploadlocalfilebtn_CSS")))
						.isDisplayed();

				if (uploadButton2 == true) {
					...
					// ReportNG
					Reporter.log("<br>" + "The user able to access the Upload Local File Button without permission : "
							+ "<br>");
					Reporter.log("<a target=\"_blank\" href=" + TestUtil.screenshotName + "><img src="
							+ TestUtil.screenshotName + " height=200 width=200></img></a>");
					Reporter.log("<br>");
					...
					test.log(LogStatus.FAIL,
							" The user able to access the Upload Local File Button without permission : ");
					test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));

					System.out.println("The user able to access the Upload Local File Button without permission");
					log.info("The user able to access the Upload Local File Button without permission");
				}
				...
				// ReportNG
				Reporter.log(
						"<br>" + "The user able to access the Upload Local File Button without permission : " + "<br>");
				Reporter.log("<a target=\"_blank\" href=" + TestUtil.screenshotName + "><img src="
						+ TestUtil.screenshotName + " height=200 width=200></img></a>");
				Reporter.log("<br>");
				Reporter.log("<br>");
				...
				// Extent Report
				test.log(LogStatus.FAIL, " The user able to access the Upload Local File Button without permission : ");
				test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));
			...
			// VERIFY THE PERMISSION TO MODIFY TASK ATTACHMENTS IN THE JINESH HR
			...
			try {
				...
				// verify upload local file button is displayed or not
				boolean uploadButton3 = driver
						.findElement(
								By.cssSelector(OR.getProperty("task_addtask_attachmentstab_uploadlocalfilebtn_CSS")))
						.isDisplayed();

				if (uploadButton3 == true) {
					...
					System.out.println("The user not able to access the Upload Local File Button as expected.");
					test.log(LogStatus.INFO, "The user not able to access the Upload Local File Button as expected.");
					Reporter.log("The user not able to access the Upload Local File Button as expected.");
					log.info("The user not able to access the Upload Local File Button as expected.");
			...
			try {
				...
				if (downloadbtn3 == true) {
					...
					// ReportNG
					Reporter.log("<br>" + "The Download button is displayed: " + "<br>");
					Reporter.log("<a target=\"_blank\" href=" + TestUtil.screenshotName + "><img src="
							+ TestUtil.screenshotName + " height=200 width=200></img></a>");
					Reporter.log("<br>");
					Reporter.log("<br>");
					...
					// Extent Report
					test.log(LogStatus.FAIL, " The Download button is displayed : ");
					test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));

					System.out.println("The Download button is displayed");
					log.info("The Download button is displayed");
		...
		try {
			...
			try {
				helper.deleteVerification("propertyproject_mu_addedrepair_attachment3_XPATH",
						"Test SS Attachment 3 Mortgage Undertakings Title");
			...
			helper.deleteVerification("propertyproject_mu_addedmortgageundertakings_attachment3_XPATH",
					"UNDERTAKINGSSATTACHMENTTHREE2021");

...
public class RR4931PropertyProjectTwoTest extends TestBase {
	...
	public void rR4931PropertyProjectTwoTest(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		title("APPLY THE \\\"PERMISSION TO MARK ATTACHMENTS AS RESTRICTED\\\" SECURITY SETTINGS TO THE ATTACHMENT FOR THE REPAIR (TASK).");
		...
		try {
			...
			try {
				...
				if (checkbox == true) {
					successMessage("The user able to access the Restricted Attachment checkbox as expected.");
				}
			...
			title("VERIFY THE RESTRICTED ATTACHMENT ACCESS IN THE JINESH CONTRACTOR");
			...
			title("VERIFY THE RESTRICTED ATTACHMENT ACCESS IN THE JINESH HR");
			...
			try {
				...
				successMessage("The user not able to access the Restricted Attachment checkbox as expected.");
			}

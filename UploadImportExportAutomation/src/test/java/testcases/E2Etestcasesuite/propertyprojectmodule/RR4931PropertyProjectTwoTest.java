...
public class RR4931PropertyProjectTwoTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR4931PropertyProjectTwoTest(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR4931PropertyProjectTwoTest");

		// APPLY THE "PERMISSION TO MARK ATTACHMENTS AS RESTRICTED" SECURITY SETTINGS TO
		// THE ATTACHMENT FOR THE REPAIR (TASK)

		System.out.println(
				"APPLY THE \"PERMISSION TO MARK ATTACHMENTS AS RESTRICTED\" SECURITY SETTINGS TO THE ATTACHMENT FOR THE REPAIR (TASK).");
		...
		try {
			...
			// APPLY THE PERMISSION TO MARK ATTACHMENTS AS RESTRICTED

			helper.addPermissionOneUsersRole(data, "security_setting_attachment_2",
...
//			uploadFile(System.getProperty("user.dir") + "\\src\\test\\resources\\logs\\sample.pdf");
			...
			// wait for the element
			explicitWaitClickable("propertyproject_mu_addedrepair_attachment2_XPATH");

			// verify newly created repair is displayed or not
			switchVerification("propertyproject_mu_addedrepair_attachment2_XPATH",
					"Test SS Attachment 2 Mortgage Undertakings Title",
					"The Test SS Attachment 2 Mortgage Undertakings Title is not displayed.");
			...
			// wait for the element
			explicitWaitClickable("propertyproject_mu_addedmortgageundertakings_attachment2_XPATH");

			// verify newly created mortgage undertaking is displayed or not
			switchVerification("propertyproject_mu_addedmortgageundertakings_attachment2_XPATH",
					"UNDERTAKINGSSATTACHMENTTWO2021", "The UNDERTAKINGSSATTACHMENTTWO2021 is not displayed.");
		...
		try {
			...
			click("propertyproject_mu_addedmortgageundertakings_attachment2_XPATH");
			ngDriver.waitForAngularRequestsToFinish();
			...
			click("propertyproject_mu_addedrepair_attachment2_XPATH");
			ngDriver.waitForAngularRequestsToFinish();
			...
			try {
				...
				// click on the restricted attachment checkbox
				click("propertyproject_mu_restrictedattachmentcbx_XPATH");
				ngDriver.waitForAngularRequestsToFinish();
				System.out.println("Clicked on the restricted attachment checkbox.");

				boolean checkbox = driver
						.findElement(By.xpath(OR.getProperty("propertyproject_mu_restrictedattachmentcbx_XPATH")))
						.isSelected();

				if (checkbox == true) {

					System.out.println("The user able to access the Restricted Attachment checkbox as expected.");
					test.log(LogStatus.INFO, "The user able to access the Restricted Attachment checkbox as expected.");
					Reporter.log("The user able to access the Restricted Attachment checkbox as expected.");
					log.info("The user able to access the Restricted Attachment checkbox as expected.");
				...
				// ReportNG
				Reporter.log("<br>"
						+ "The user not able to access the Restricted Attachment checkbox with permission : " + "<br>");
				Reporter.log("<a target=\"_blank\" href=" + TestUtil.screenshotName + "><img src="
						+ TestUtil.screenshotName + " height=200 width=200></img></a>");
				Reporter.log("<br>");
				Reporter.log("<br>");
				...
				test.log(LogStatus.FAIL,
						" The user not able to access the Restricted Attachment checkbox with permission : ");
				test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));

				System.out.println("The user not able to access the Restricted Attachment checkbox with permission");
				log.info("The user not able to access the Restricted Attachment checkbox with permission");
			...
			try {
				...
				if (checkbox == true) {
					...
					// ReportNG
					Reporter.log(
							"<br>" + "The user able to access the Restricted Attachment checkbox without permission : "
									+ "<br>");
					Reporter.log("<a target=\"_blank\" href=" + TestUtil.screenshotName + "><img src="
							+ TestUtil.screenshotName + " height=200 width=200></img></a>");
					Reporter.log("<br>");
					...
					// Extent Report
					test.log(LogStatus.FAIL,
							" The user able to access the Restricted Attachment checkbox without permission : ");
					test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));

					System.out.println("The user able to access the Restricted Attachment checkbox without permission");
					log.info("The user able to access the Restricted Attachment checkbox without permission");

				}

			} catch (Throwable t) {
				System.out.println("The user not able to access the Restricted Attachment checkbox as expected.");
				test.log(LogStatus.INFO, "The user not able to access the Restricted Attachment checkbox as expected.");
				Reporter.log("The user not able to access the Restricted Attachment checkbox as expected.");
				log.info("The user not able to access the Restricted Attachment checkbox as expected.");
			}
		...
		try {
			...
			try {
				helper.deleteVerification("propertyproject_mu_addedrepair_attachment2_XPATH",
						"Test SS Attachment 2 Mortgage Undertakings Title");
			...
			helper.deleteVerification("propertyproject_mu_addedmortgageundertakings_attachment2_XPATH",
					"UNDERTAKINGSSATTACHMENTTWO2021");

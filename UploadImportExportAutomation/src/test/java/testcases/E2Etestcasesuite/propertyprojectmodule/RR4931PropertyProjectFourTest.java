...
public class RR4931PropertyProjectFourTest extends TestBase {
	...
	public void rR4931PropertyProjectFourTest(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		System.out.println(
				"APPLY THE \"PERMISSION TO VIEW RESTRICTED ATTACHMENTS\" SECURITY SETTINGS TO THE ATTACHMENT FOR THE REPAIR (TASK).");
...
//			uploadFile(System.getProperty("user.dir") + "\\src\\test\\resources\\logs\\sample.pdf");
				...
				if (str1.equals("sample.pdf")) {
					...
					ngDriver.waitForAngularRequestsToFinish();
					System.out.println("Clicked on the restriction attachment checklist.");
		...
		try {
			...
			try {
				...
				if (file1 == true) {
					...
					System.out.println("The user able to access the Restricted Attachment as expected.");
					test.log(LogStatus.INFO, "The user able to access the Restricted Attachment as expected.");
					Reporter.log("The user able to access the Restricted Attachment as expected.");
					log.info("The user able to access the Restricted Attachment as expected.");
				...
				// ReportNG
				Reporter.log(
						"<br>" + "The user not able to access the Restricted Attachment with permission : " + "<br>");
				Reporter.log("<a target=\"_blank\" href=" + TestUtil.screenshotName + "><img src="
						+ TestUtil.screenshotName + " height=200 width=200></img></a>");
				Reporter.log("<br>");
				Reporter.log("<br>");
				...
				// Extent Report
				test.log(LogStatus.FAIL, " The user not able to access the Restricted Attachment with permission : ");
				test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));

				System.out.println("The user not able to access the Restricted Attachment with permission");
				log.info("The user not able to access the Restricted Attachment with permission");
			...
			try {
				...
				if (file1 == true) {
					...
					// ReportNG
					Reporter.log("<br>" + "The user able to access the Restricted Attachment without permission : "
							+ "<br>");
					Reporter.log("<a target=\"_blank\" href=" + TestUtil.screenshotName + "><img src="
							+ TestUtil.screenshotName + " height=200 width=200></img></a>");
					Reporter.log("<br>");
					...
					test.log(LogStatus.FAIL,
							" The user able to access the Restricted Attachment without permission : ");
					test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));

					System.out.println("The user able to access the Restricted Attachment without permission");
					log.info("The user able to access the Restricted Attachment without permission");

				}

			} catch (Throwable t) {

				System.out.println("The user not able to access the Restricted Attachment as expected.");
				test.log(LogStatus.INFO, "The user not able to access the Restricted Attachment as expected.");
				Reporter.log("The user not able to access the Restricted Attachment as expected.");
				log.info("The user not able to access the Restricted Attachment as expected.");

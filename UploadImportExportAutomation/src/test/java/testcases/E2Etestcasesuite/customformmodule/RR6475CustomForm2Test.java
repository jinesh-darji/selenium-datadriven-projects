...
public class RR6475CustomForm2Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR6475CustomForm2Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR6475CustomForm2Test");

		// VALIDATE THE PDF REPORT OF THE RAMDOM NUMBER OF DETAILS OF THE CUSTOM RECORDS
		// IN THE PORTFOLIO DASHBOARD AND PROPERTY SUMMARY DASHBOARD - MULTIPLE TYPE
		title("VALIDATE THE PDF REPORT OF THE RAMDOM NUMBER OF DETAILS OF THE CUSTOM RECORDS IN THE PORTFOLIO DASHBOARD AND PROPERTY SUMMARY DASHBOARD - MULTIPLE TYPE");

...
public class RR6034Sustainability3Test extends TestBase {
	...
	public void rR6034Sustainability3Test(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		System.out.println("VALIDATE THE ACCESS TO IMPORT METERS SECURITY SETTINGS");
		test.log(LogStatus.INFO, "VALIDATE THE ACCESS TO IMPORT METERS SECURITY SETTINGS");
		Reporter.log("VALIDATE THE ACCESS TO IMPORT METERS SECURITY SETTINGS");
		log.info("VALIDATE THE ACCESS TO IMPORT METERS SECURITY SETTINGS");
		...
		System.out.println("***************** UPDATE THE ACCESS TO IMPORT METERS SECURITY SETTINGS *****************");
		test.log(LogStatus.INFO,
				"***************** UPDATE THE ACCESS TO IMPORT METERS SECURITY SETTINGS *****************");
		Reporter.log("***************** UPDATE THE ACCESS TO IMPORT METERS SECURITY SETTINGS *****************");
		log.info("***************** UPDATE THE ACCESS TO IMPORT METERS SECURITY SETTINGS *****************");
		...
		System.out.println("***************** VALIDATE IMPORT METERS OPTION IN ADMIN USER *****************");
		test.log(LogStatus.INFO, "***************** VALIDATE IMPORT METERS OPTION IN ADMIN USER *****************");
		Reporter.log("***************** VALIDATE IMPORT METERS OPTION IN ADMIN USER *****************");
		log.info("***************** VALIDATE IMPORT METERS OPTION IN ADMIN USER *****************");

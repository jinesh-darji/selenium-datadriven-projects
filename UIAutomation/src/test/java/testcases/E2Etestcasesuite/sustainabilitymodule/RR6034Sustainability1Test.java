...
public class RR6034Sustainability1Test extends TestBase {
	...
	public void rR6034Sustainability1Test(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		title("VALIDATE THE ACCESS TO ENERGY DASHBOARD OPTIONS SECURITY SETTINGS");
		...
		title("UPDATE THE ACCESS TO ENERGY DASHBOARD OPTIONS SECURITY SETTINGS");
		...
		try {
			...
			title("VALIDATE ACCESS TO ENERGY DASHBOARD OPTIONS IN PROPERTY MANAGER USER");

...
public class RR5964Sustainability2Test extends TestBase {
	...
	public void rR5964Sustainability2Test(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		System.out.println("PERFORMED CRUD OPERATION OF THE UTILITY BILLS MODULE - AT BUILDING LEVEL");
		test.log(LogStatus.INFO, "PERFORMED CRUD OPERATION OF THE UTILITY BILLS MODULE - AT BUILDING LEVEL");
		Reporter.log("PERFORMED CRUD OPERATION OF THE UTILITY BILLS MODULE - AT BUILDING LEVEL");
		log.info("PERFORMED CRUD OPERATION OF THE UTILITY BILLS MODULE - AT BUILDING LEVEL");
		...
		System.out.println("***************** CREATE NEW UTILITY BILLS RECORD - AT BUILDING LEVEL *****************");
		test.log(LogStatus.INFO,
				"***************** CREATE NEW UTILITY BILLS RECORD - AT BUILDING LEVEL *****************");
		Reporter.log("***************** CREATE NEW UTILITY BILLS RECORD - AT BUILDING LEVEL *****************");
		log.info("***************** CREATE NEW UTILITY BILLS RECORD - AT BUILDING LEVEL *****************");
		...
		try {
			...
			ngDriver.waitForAngularRequestsToFinish();
			System.out.println("Selected the building from the dropdown.");
			...
			type("sustainability_searchtxt_XPATH", utilityBills_property);
			ngDriver.waitForAngularRequestsToFinish();
			System.out.println("Entered the newly created utility bills record in the search field.");
			...
			try {
				...
				if (addedutilityBills.equals(utilityBills_property)) {
					...
					// ReportNG
					Reporter.log("<br>" + "The property utility bills is displayed at building level : " + "<br>");
					...
					// Extent Report
					test.log(LogStatus.FAIL, " The property utility bills is displayed at building level : ");
					test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));

					System.out.println("The property utility bills is displayed at building level.");
					log.info("The property utility bills is displayed at building level.");
				} else {

					System.out.println("The property utility bills is not displayed at building level as expected.");
					test.log(LogStatus.INFO,
							"The property utility bills is not displayed at building level as expected.");
					Reporter.log("The property utility bills is not displayed at building level as expected.");
					log.info("The property utility bills is not displayed at building level as expected.");
				}
			} catch (Throwable t) {
				System.out.println("The property utility bills is not displayed at building level as expected.");
				test.log(LogStatus.INFO, "The property utility bills is not displayed at building level as expected.");
				Reporter.log("The property utility bills is not displayed at building level as expected.");
				log.info("The property utility bills is not displayed at building level as expected.");
			}
		...
		try {
			...
			type("sustainability_searchtxt_XPATH", utilityBills_building);
			ngDriver.waitForAngularRequestsToFinish();
			System.out.println("Entered the newly created utility meter record in the search field.");
		...
		System.out.println(
				"***************** DELETE THE UPDATED utility bills RECORD - AT PROPERTY AND BUILDING LEVEL *****************");
		test.log(LogStatus.INFO,
				"***************** DELETE THE UPDATED utility bills RECORD - AT PROPERTY AND BUILDING LEVEL *****************");
		Reporter.log(
				"***************** DELETE THE UPDATED utility bills RECORD - AT PROPERTY AND BUILDING LEVEL *****************");
		...
		try {
			...
			type("sustainability_searchtxt_XPATH", utilityBills_property);
			ngDriver.waitForAngularRequestsToFinish();
			System.out.println("Entered the updated utility bills record in the search field.");
			...
			try {
				...
				if (updatedutilityBills1.equals(utilityBills_property)) {
					...
					// ReportNG
					Reporter.log("<br>" + "The utility bills is not deleted : " + "<br>");
					Reporter.log("<a target=\"_blank\" href=" + TestUtil.screenshotName + "><img src="
							+ TestUtil.screenshotName + " height=200 width=200></img></a>");
					Reporter.log("<br>");
					Reporter.log("<br>");
					...
					// Extent Report
					test.log(LogStatus.FAIL, " The utility bills is not deleted : ");
					test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));

					System.out.println("The utility bills is not deleted.");
					log.info("The utility bills is not deleted.");

				}
			} catch (Throwable t) {
				System.out.println("The utility bills is deleted successfully.");
				test.log(LogStatus.INFO, "The utility bills is deleted successfully.");
				Reporter.log("The utility bills is deleted successfully.");
				log.info("The utility bills is deleted successfully.");
			}

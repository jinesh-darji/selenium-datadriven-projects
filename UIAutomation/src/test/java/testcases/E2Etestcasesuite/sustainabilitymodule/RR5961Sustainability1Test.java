...
public class RR5961Sustainability1Test extends TestBase {
	...
	public void rR5961Sustainability1Test(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		System.out.println("PERFORMED CRUD OPERATION OF THE UTILITY METERS MODULE - AT PROPERTY LEVEL");
		test.log(LogStatus.INFO, "PERFORMED CRUD OPERATION OF THE UTILITY METERS MODULE - AT PROPERTY LEVEL");
		Reporter.log("PERFORMED CRUD OPERATION OF THE UTILITY METERS MODULE - AT PROPERTY LEVEL");
		log.info("PERFORMED CRUD OPERATION OF THE UTILITY METERS MODULE - AT PROPERTY LEVEL");
		...
		System.out.println("***************** UPDATE THE NEWLY CREATED UTILITY METER RECORD *****************");
		test.log(LogStatus.INFO, "***************** UPDATE THE NEWLY CREATED UTILITY METER RECORD *****************");
		Reporter.log("***************** UPDATE THE NEWLY CREATED UTILITY METER RECORD *****************");
		log.info("***************** UPDATE THE NEWLY CREATED UTILITY METER RECORD *****************");

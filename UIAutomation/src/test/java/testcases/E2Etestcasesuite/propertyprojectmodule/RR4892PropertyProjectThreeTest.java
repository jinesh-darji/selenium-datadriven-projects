...
public class RR4892PropertyProjectThreeTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR4892PropertyProjectThreeTest(Hashtable<String, String> data)
			throws IOException, InterruptedException {

		execution(data, "rR4892PropertyProjectThreeTest");
		...
		try {
			...
			try {
				...
				switchVerification("propertyproject_mu_addedmortgageundertakings_deletess1_XPATH",
						"UNDERTAKINGPERMISSIONDELETEONE2021", "Mortgage Undertakings is not displayed successfully.");

...
public class RR4968PropertyProjectOneTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR4968PropertyProjectOneTest(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR4968PropertyProjectOneTest");
		...
		System.out.println(
				"APPLY THE \"ACCESS TO MARK COMMENTS AS RESTRICTED\" SECURITY SETTINGS TO THE COMMENTS FOR THE REPAIR OF THE MORTGAGE UNDERTAKING..");
		...
		try {
			...
			switchVerification("propertyproject_mu_addedmortgageundertakings_taskcomment1_XPATH",
					"UNDERTAKINGSSTASKCOMMENTONE2021", "The UNDERTAKINGSSTASKCOMMENTONE2021 is not displayed.");

			// click on the newly created mortgage undertaking
			click("propertyproject_mu_addedmortgageundertakings_taskcomment1_XPATH");
			ngDriver.waitForAngularRequestsToFinish();
			System.out.println("Clicked on the newly created mortgage undertaking.");

			// scroll down the screen
			js.executeScript("window.scrollBy(0,600)");

			// click on the newly created repair
			click("propertyproject_mu_addedrepair_taskcomment1_XPATH");
			ngDriver.waitForAngularRequestsToFinish();
		...
		try {
			...
			try {
				...
				click("propertyproject_mu_updaterestrictedcheckboxtask_CSS");
				ngDriver.waitForAngularRequestsToFinish();
				System.out.println("Clicked on the restricted comment check box.");

				// VERITY CHECKED COMMENT IS DISPLAYED OR NOT
				switchVerification("propertyproject_mu_restrictedtaskcomment1_XPATH",
						"Test Task Comment 1 Mortgage Undertakings Description",
						"The Test Task Comment 1 Mortgage Undertakings Description is not displayed.");

				boolean checked1 = driver
						.findElement(
								By.cssSelector(OR.getProperty("propertyproject_mu_updaterestrictedcheckboxtask_CSS")))
						.isDisplayed();
			...
			try {
				...
				if (checked3 == true) {
					...
					// ReportNG
					Reporter.log("<br>" + "The Restricted Comment Checkbox is displayed: " + "<br>");
					Reporter.log("<a target=\"_blank\" href=" + TestUtil.screenshotName + "><img src="
							+ TestUtil.screenshotName + " height=200 width=200></img></a>");
					Reporter.log("<br>");
					Reporter.log("<br>");
					...
					// Extent Report
					test.log(LogStatus.FAIL, " The Restricted Comment Checkbox is displayed : ");
					test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));

					System.out.println("The Restricted Comment Checkbox is displayed");
					log.info("The Restricted Comment Checkbox is displayed");

				} else {

					System.out.println("The Restricted Comment Checkbox is not displayed as expected.");
					test.log(LogStatus.INFO, "The Restricted Comment Checkbox is not displayed as expected.");
					Reporter.log("The Restricted Comment Checkbox is not displayed as expected.");
					log.info("The Restricted Comment Checkbox is not displayed as expected.");
		...
		try {
			...
			helper.deleteVerification("propertyproject_mu_addedmortgageundertakings_taskcomment1_XPATH",
					"UNDERTAKINGSSTASKCOMMENTONE2021");

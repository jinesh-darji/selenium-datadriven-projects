...
public class RR4968PropertyProjectOneTest extends TestBase {
	...
	public void rR4968PropertyProjectOneTest(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		title("APPLY THE \\\"ACCESS TO MARK COMMENTS AS RESTRICTED\\\" SECURITY SETTINGS TO THE COMMENTS FOR THE REPAIR OF THE MORTGAGE UNDERTAKING.");
		...
		try {
			...
			title("VERIFY THE ACCESS TO MARK COMMENTS AS RESTRICTED IN THE JINESH USER");

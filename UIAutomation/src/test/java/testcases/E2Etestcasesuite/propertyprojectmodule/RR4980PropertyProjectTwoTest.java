...
public class RR4980PropertyProjectTwoTest extends TestBase {
	...
	public void rR4980PropertyProjectTwoTest(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		title("THE \\\"ASSIGNED TO\\\" FIELD MUST FETCH THE DEFAULT USER LIST AS CONFIGURED IN SECURITY SETTINGS - CAPEX PROJECTS.");
		...
		try {
			...
			// APPLY THE ACCESS OF DEFAULT PROPERTY PROJECT CAPEX PROJECTS TASK ASSIGNEES
			title("APPLY THE ACCESS OF DEFAULT PROPERTY PROJECT CAPEX PROJECTS TASK ASSIGNEES");
			...
			title("ADD SECURITY SETTINGS OF VIEW CAPEX PROJECTS TO USER/ROLE ACCESS");
		...
		// PROJECTS
		title("VERIFY DEFAULT USERS / ROLES DISPLAYED IN THE ASSIGN TO FIELD - CAPEX PROJECTS");
		...
		try {
			...
			try {
				...
				successMessage("The default user/role are: " + str1 + " " + str2);
		...
		title("DELETE THE CAPEX PROJECTSS");

...
public class RR4809PropertyProjectTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR4809PropertyProjectTest(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR4809PropertyProjectTest");

		// PREPARE THE CRUD OPERATION OF THE MORTGAGE UNDERTAKINGS MODULE.

		System.out.println("PREPARE THE CRUD OPERATION OF THE MORTGAGE UNDERTAKINGS MODULE.");
		test.log(LogStatus.INFO, "PREPARE THE CRUD OPERATION OF THE MORTGAGE UNDERTAKINGS MODULE.");
		Reporter.log("PREPARE THE CRUD OPERATION OF THE MORTGAGE UNDERTAKINGS MODULE.");
		log.info("PREPARE THE CRUD OPERATION OF THE MORTGAGE UNDERTAKINGS MODULE.");
...
//		System.out.println("click on the save button");
			...
			// wait for the element
			explicitWait("propertyproject_mu_addedrepair1_XPATH");

			// verify newly created repair is displayed or not
			switchVerification("propertyproject_mu_addedrepair1_XPATH", "Test CRUD Mortgage Undertakings Title Record",
					"The Test CRUD Mortgage Undertakings Title Record is not displayed.");
			...
			switchVerification("propertyproject_mu_addedmortgageundertakings1_XPATH", "UNDERTAKING2021",
					"Mortgage Undertakings is not displayed successfully.");

			// UPDATE THE MORTGAGE UNDERTAKING

			System.out.println("**************** UPDATE MORTGAGE UNDERTAKINGS ****************");
			test.log(LogStatus.INFO, "**************** UPDATE MORTGAGE UNDERTAKINGS ****************");
			Reporter.log("**************** UPDATE MORTGAGE UNDERTAKINGS ****************");
			log.info("**************** UPDATE MORTGAGE UNDERTAKINGS ****************");

			// UPDATE THE DETAILS OF THE REPAIR

			// click on the newly created Mortgage Undertakings
			click("propertyproject_mu_addedmortgageundertakings1_XPATH");
			ngDriver.waitForAngularRequestsToFinish();
			...
			click("propertyproject_mu_addedrepair1_XPATH");
			ngDriver.waitForAngularRequestsToFinish();
			...
			// wait for the element
			explicitWait("propertyproject_mu_updatedrepair1_XPATH");

			// verify updated repair title is displayed or not
			switchVerification("propertyproject_mu_updatedrepair1_XPATH",
					"Update Test CRUD Mortgage Undertakings Title Record",
					"The Update Test CRUD Mortgage Undertakings Title Record is not displayed.");
			...
			switchVerification("propertyproject_mu_updatedundertaking_XPATH", "UPDATEUNDERTAKING2021",
					"The UPDATEUNDERTAKING2021 is not displayed.");
			...
			click("propertyproject_mu_updatedundertaking_XPATH");
			ngDriver.waitForAngularRequestsToFinish();
			System.out.println("Clicked on the newly created Mortgage Undertakings.");
			...
			click("propertyproject_mu_updatedrepair1_XPATH");
			ngDriver.waitForAngularRequestsToFinish();
			...
			helper.deleteVerification("propertyproject_mu_updatedrepair1_XPATH",
					"Update Test CRUD Mortgage Undertakings Title Record");
			...
			helper.deleteVerification("propertyproject_mu_updatedundertaking_XPATH", "UPDATEUNDERTAKING2021");

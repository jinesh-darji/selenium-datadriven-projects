...
public class RR5001PropertyProjectTwoTest extends TestBase {
	...
	public void rR5001PropertyProjectTwoTest(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		title("CAPEX PROJECTS COUNTS ON A PROPERTY LEVEL.");
		...
		title("DELETE CAPEX PROJECTSS FROM THE PROPERTY ONE");
		...
		try {
			...
			title("ADD RECORD - CAPEX PROJECTSS");
			...
			title("VERIFY CAPEX PROJECTS COUNT ON PROPERTY LEVEL FOR THE PROPERTY ONE");
			...
			try {
				...
				consoleMessage("The capex projects actual count is : " + actualCount + " and expected count is : "
						+ expectedCount);

				if (actualCount.equals(expectedCount)) {
					successMessage("The capex projects counts are displayed correct in the property one.");
				} else {
		...
		title("DELETE CAPEX PROJECTSS FROM THE PROPERTY TWO");
		...
		try {
			...
			title("VERIFY CAPEX PROJECTS COUNT ON PROPERTY LEVEL FOR THE PROPERTY TWO");
			...
			try {
				...
				consoleMessage("The capex projects actual count is : " + actualCount2 + " and expected count is : "
						+ expectedCount2);

				if (actualCount2.equals(expectedCount2)) {
					successMessage("The capex projects counts are displayed correct in the property two.");
				} else {
					verificationFailedMessage(
		...
		title("DELETE CAPEX PROJECTSS OF PROPERTY ONE");
		...
		// DELETE CAPEX PROJECTSS OF PROPERTY TWO
		title("DELETE CAPEX PROJECTSS OF PROPERTY TWO");

...
public class RR4969PropertyProjectOneTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR4969PropertyProjectOneTest(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR4969PropertyProjectOneTest");
		...
		try {
			...
			switchVerification("propertyproject_mu_addedmortgageundertakings_comment1_XPATH",
					"UNDERTAKINGSSCOMMENTONE2021", "The UNDERTAKINGSSCOMMENTONE2021 is not displayed.");
		...
		try {
			...
			try {
				...
				switchVerification("propertyproject_mu_restrictedcomment1_XPATH",
						"Test SS Comment 1 Mortgage Undertakings",
						"The Test SS Comment 1 Mortgage Undertakings is not displayed.");

				boolean checked1 = driver
						.findElement(By.cssSelector(OR.getProperty("propertyproject_mu_checkedrestrictedcheckbox_CSS")))
						.isSelected();

...
public class RR4892PropertyProjectTwoTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR4892PropertyProjectTwoTest(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR4892PropertyProjectTwoTest");

		// APPLY THE SECURITY SETTING OF THE EDIT MORTGAGE UNDERTAKING PERMISSION TO THE
		// ASSIGNED USER/ROLE AND RESPECTIVE USER/ROLE MUST HAVE ONLY GRANTED PERMISSION
		// TO PERFORM ACTIONS.

		System.out.println(
				"APPLY THE SECURITY SETTING OF THE EDIT MORTGAGE UNDERTAKING PERMISSION TO THE ASSIGNED USER/ROLE AND RESPECTIVE USER/ROLE MUST HAVE ONLY GRANTED PERMISSION TO PERFORM ACTIONS.");
		...
		System.out.println(
				"*************** EDIT SECURITY SETTINGS OF VIEW / EDIT MORTGAGE UNDERTAKING TO USER/ROLE ACCESS *************");
		test.log(LogStatus.INFO,
				"*************** EDIT SECURITY SETTINGS OF VIEW / EDIT MORTGAGE UNDERTAKING TO USER/ROLE ACCESS *************");
		Reporter.log(
				"*************** EDIT SECURITY SETTINGS OF VIEW / EDIT MORTGAGE UNDERTAKING TO USER/ROLE ACCESS *************");
		...
		try {
			...
			helper.addPermissionOneUsersRole(data, "security_setting_3", "propertyproject_securitysettings3_XPATH");
		...
		try {
			...
			try {
				...
				switchVerification("propertyproject_mu_addedmortgageundertakings_editss1_XPATH",
						"UNDERTAKINGPERMISSIONEDITONE2021", "Mortgage Undertakings is not displayed successfully.");
			...
			try {
				...
				// verification of the Mortgage Undertakings is added or not
				switchVerification("propertyproject_mu_addedmortgageundertakings2_editss1_XPATH",
						"UNDERTAKINGPERMISSIONEDITTWO2021", "Mortgage Undertakings is not displayed successfully.");
		...
		try {
			...
			try {
				...
				click("propertyproject_mu_addedmortgageundertakings_editss1_XPATH");
				ngDriver.waitForAngularRequestsToFinish();
				...
				// verify the updated mortgage undertaking
				switchVerification("propertyproject_mu_updatedmortgageundertakings_editss1_XPATH",
						"UPDATEUNDERTAKINGPERMISSIONEDITONE2021",
						"The UPDATEUNDERTAKINGPERMISSIONEDITONE2021 is not displayed.");

				System.out.println("The user able to update the Mortgage Undertakings details as expected.");
				test.log(LogStatus.INFO, "The user able to update the Mortgage Undertakings details as expected");
				Reporter.log("The user able to update the Mortgage Undertakings details as expected");
				log.info("The user able to update the Mortgage Undertakings details as expected");
				...
				// ReportNG
				Reporter.log("<br>" + "The user not able to update the Mortgage Undertakings details with the Access: "
						+ "<br>");
				Reporter.log("<a target=\"_blank\" href=" + TestUtil.screenshotName + "><img src="
						+ TestUtil.screenshotName + " height=200 width=200></img></a>");
				Reporter.log("<br>");
				...
				// Extent Report
				test.log(LogStatus.FAIL,
						" The user not able to update the Mortgage Undertakings details with the Access : ");
				test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));

				System.out.println("The user not able to update the Mortgage Undertakings details with the Access.");
				log.info("The user not able to update the Mortgage Undertakings details with the Access.");
			...
			// VERIFY THE JINESH CONTRACTOR ABLE TO ADD THE MORTGAGE UNDERTAKING DETAILS OR
			// NOT

			System.out.println("**************** ADD MORTGAGE UNDERTAKINGS - JINESH CONTRACTOR ****************");
			test.log(LogStatus.INFO, "**************** ADD MORTGAGE UNDERTAKINGS - JINESH CONTRACTOR ****************");
			Reporter.log("**************** ADD MORTGAGE UNDERTAKINGS - JINESH CONTRACTOR ****************");
			log.info("**************** ADD MORTGAGE UNDERTAKINGS - JINESH CONTRACTOR ****************");
			...
			System.out.println("**************** UPDATE MORTGAGE UNDERTAKINGS - JINESH CONTRACTOR ****************");
			test.log(LogStatus.INFO,
					"**************** UPDATE MORTGAGE UNDERTAKINGS - JINESH CONTRACTOR ****************");
			Reporter.log("**************** UPDATE MORTGAGE UNDERTAKINGS - JINESH CONTRACTOR ****************");
			log.info("**************** UPDATE MORTGAGE UNDERTAKINGS - JINESH CONTRACTOR ****************");

			try {

				// click on the newly created Mortgage Undertakings
				click("propertyproject_mu_addedmortgageundertakings2_editss1_XPATH");
				ngDriver.waitForAngularRequestsToFinish();
				System.out.println("Clicked on the newly created Mortgage Undertakings.");
				...
				// verify the updated mortgage undertaking
				switchVerification("propertyproject_mu_updatedmortgageundertakings2_editss1_XPATH",
						"UPDATEUNDERTAKINGPERMISSIONEDITTWO2021",
						"The UPDATEUNDERTAKINGPERMISSIONEDITTWO2021 is not displayed.");
			...
			System.out.println("**************** DELETE MORTGAGE UNDERTAKINGS - JINESH CONTRACTOR ****************");
			test.log(LogStatus.INFO,
					"**************** DELETE MORTGAGE UNDERTAKINGS - JINESH CONTRACTOR ****************");
			Reporter.log("**************** DELETE MORTGAGE UNDERTAKINGS - JINESH CONTRACTOR ****************");
			log.info("**************** DELETE MORTGAGE UNDERTAKINGS - JINESH CONTRACTOR ****************");
		...
		try {
			...
			helper.deleteVerification("propertyproject_mu_addedmortgageundertakings_editss1_XPATH",
					"UNDERTAKINGPERMISSIONEDITONE2021");

			// verify newly created MORTGAGE UNDERTAKINGS - JINESHCONTRACTOR is deleted or
			// not

			helper.deleteVerification("propertyproject_mu_addedmortgageundertakings2_editss1_XPATH",
					"UNDERTAKINGPERMISSIONEDITTWO2021");

			// verify newly created MORTGAGE UNDERTAKINGS - JINESHHR is deleted or not

			helper.deleteVerification("propertyproject_mu_addedmortgageundertakings3_editss1_XPATH",
					"UNDERTAKINGPERMISSIONEDITTHREE2021");

...
public class RR4904PropertyProjectThreeTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR4904PropertyProjectThreeTest(Hashtable<String, String> data)
			throws IOException, InterruptedException {

		execution(data, "rR4904PropertyProjectThreeTest");
		...
		try {
			...
			try {
				...
				switchVerification("propertyproject_cp_addedcapexprojects_deletess1_XPATH",
						"CAPEXPROJECTSDELETEONE2021", "CAPEX Projects is not displayed successfully.");
		...
		try {
			...
			try {
				...
				boolean mu1 = driver.findElement(By.xpath(OR.getProperty("propertyproject_cp_deletebtn_XPATH")))
						.isDisplayed();
			...
			try {
				...
				boolean mu3 = driver.findElement(By.xpath(OR.getProperty("propertyproject_cp_deletebtn_XPATH")))
						.isDisplayed();
		...
		try {
			...
			for (int i = 0; i < count - 1; i++) {
				...
				// wait for the element
				explicitWaitClickable("propertyproject_cp_deletebtn_XPATH");

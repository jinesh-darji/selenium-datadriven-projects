...
public class RR6569CustomForm3Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR6569CustomForm3Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR6569CustomForm3Test");

		// VERIFY THE LOCKDOWN PREVIOUS PERIOD FEATURE WITH A CORPORATE-LEVEL CUSTOM
		// FORM MULTIPLE TIMES.
		title("VERIFY THE LOCKDOWN PREVIOUS PERIOD FEATURE WITH A CORPORATE-LEVEL CUSTOM FORM MULTIPLE TIMES.");
		...
		try {
			...
			// click on the first record of the corporate type custom form
			String first_record = "//span[text()='" + field1Detail_list.get(0) + "']";
			driver.findElement(By.xpath(first_record)).click();
			consoleMessage("Clicked on the first record of the corporate type custom form.");
		...
		// VALIDATE THE EDIT FUNCTIONALITY WITH PAST EFFECTIVE DATE FOR THE LOCK DOWN
		// PRERIOD WITH TODAY, PAST, AND FUTURE DATES ON PROPERTY SUMMARY DASHBOARD
		title("VALIDATE THE EDIT FUNCTIONALITY WITH PAST EFFECTIVE DATE FOR THE LOCK DOWN PRERIOD WITH TODAY, PAST, AND FUTURE DATES ON PROPERTY SUMMARY DASHBOARD");

...
public class RR6555CustomForm13Test extends TestBase {
	...
	public void rR6555CustomForm13Test(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		// SECURITY SETTINGS FOR THE MULTIPLE TYPE CUSTOM FORM.
		title("VALIDATE THE �VIEW RISK SCORING� PERMISSION OF THE SECURITY TAB AND SECURITY SETTINGS FOR THE MULTIPLE TYPE CUSTOM FORM.");

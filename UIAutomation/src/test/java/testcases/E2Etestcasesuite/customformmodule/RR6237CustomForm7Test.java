...
public class RR6237CustomForm7Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR6237CustomForm7Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR6237CustomForm7Test");

		// VALIDATE THE ALL THE PERMISSIONS OF THE SECURITY TAB OF THE CUSTOM FORMS
		// [PERFORM VARIOUS COMBINATIONS WITH THE 'USER TO EDIT FORM' AND 'ROLE TO EDIT
		// FORM' PERMISSIONS]

		title("VALIDATE THE ALL THE PERMISSIONS OF THE SECURITY TAB OF THE CUSTOM FORMS [PERFORM VARIOUS COMBINATIONS WITH THE 'USER TO EDIT FORM' AND 'ROLE TO EDIT FORM' PERMISSIONS]");

...
public class RR6340CustomForm11Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR6340CustomForm11Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR6340CustomForm11Test");

		// VALIDATE THE USER TO DELETE FORM' AND 'ROLE TO DELETE FORM' PERMISSIONS OF
		// THE CUSTOM FORMS ON THE PORTFOLIO SUMMARY DASHBOARD AND PROPERTY SUMMARY
		// DASHBOARD - MULTIPLE TYPE.
		title("VALIDATE THE USER TO DELETE FORM' AND 'ROLE TO DELETE FORM' PERMISSIONS OF THE CUSTOM FORMS ON THE PORTFOLIO SUMMARY DASHBOARD AND PROPERTY SUMMARY DASHBOARD - MULTIPLE TYPE.");
		...
		// ADD THE SECURITY PERMISSION OF DELETE CUSTOMER FORM FOR THE JINESH (PROPERTY
		// MANAGER)
		title("ADD THE SECURITY PERMISSION OF DELETE CUSTOMER FORM FOR THE JINESH (PROPERTY MANAGER)");
		...
		try {
			...
			// click on the User to Delete form
			click("customform_securitytab_security9_XPATH");
		...
		// VALIDATE THE DELETE BUTTON OF THE CUSTOM REPORT IN THE
		// PROPERTY SUMMARY DASHBOARD AND PORTFOLIO SUMMARY DASHBOARD - ADMIN USER
		title("VALIDATE THE DELETE BUTTON OF THE CUSTOM REPORT IN THE PROPERTY SUMMARY DASHBOARD AND PORTFOLIO SUMMARY DASHBOARD - ADMIN USER");
		...
		try {
			...
			try {
				...
				if (customForm1_actual.equals(data.get("name"))) {
					...
					// validate the delete button is displayed in general tab
					try {
						boolean deletebtn1 = driver
								.findElement(By.xpath(OR.getProperty("customform_records_deletebtn_XPATH")))
								.isDisplayed();
					...
					// validate the delete button is displayed in first page tab
					try {
						boolean deletebtn2 = driver
								.findElement(By.xpath(OR.getProperty("customform_records_deletebtn_XPATH")))
								.isDisplayed();
		...
		try {
			...
			// VALIDATE THE DELETE BUTTON OF THE CUSTOM REPORT IN THE PROPERTY SUMMARY
			// DASHBOARD AND PORTFOLIO SUMMARY DASHBOARD - PROPERTY MANAGER USER - JINESH

			title("VALIDATE THE DELETE BUTTON OF THE CUSTOM REPORT IN THE PROPERTY SUMMARY DASHBOARD AND PORTFOLIO SUMMARY DASHBOARD - PROPERTY MANAGER USER - JINESH");
						...
						try {
							...
							if (editbtn3 == true) {
								...
								verificationFailedMessage(
										"The delete button is not displayed, However the permission is given.");
							}
						} catch (Throwable t) {
							verificationFailedMessage(
									"The delete button is not displayed, However the permission is given.");
		...
		try {
			...
			// click on the Role to Delete form
			click("customform_securitytab_security10_XPATH");
		...
		try {
			...
			// CONTRACTOR
			title("VALIDATE THE DELETE BUTTON OF THE CUSTOM REPORT IN THE PROPERTY SUMMARY DASHBOARD AND PORTFOLIO SUMMARY DASHBOARD - CONTRACTOR USER - JINESH CONTRACTOR");
		...
		try {
			...
			title("VALIDATE THE DELETE BUTTON OF THE CUSTOM REPORT IN THE PROPERTY SUMMARY DASHBOARD AND PORTFOLIO SUMMARY DASHBOARD - HR USER - JINESH HR");

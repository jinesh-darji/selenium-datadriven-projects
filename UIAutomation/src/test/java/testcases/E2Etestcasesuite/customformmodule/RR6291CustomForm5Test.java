...
public class RR6291CustomForm5Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR6291CustomForm5Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR6291CustomForm5Test");

		// VALIDATE THE 'USER TO EDIT FORM', 'ROLE TO EDIT FORM', 'USER TO EXTRACT FORM
		// DETAILS', AND 'ROLE TO EXTRACT FORM DETAILS' PERMISSIONS OF THE CUSTOM FORMS.

		title("VALIDATE THE 'USER TO EDIT FORM', 'ROLE TO EDIT FORM', 'USER TO EXTRACT FORM DETAILS', AND 'ROLE TO EXTRACT FORM DETAILS' PERMISSIONS OF THE CUSTOM FORMS.");
		...
		try {
			...
			// ADD THE SECURITY PERMISSION OF EDIT AND EXPORT CUSTOMER FORM FOR THE JINESH
			// (PROPERTY
			// MANAGER)
			title("ADD THE SECURITY PERMISSION OF EDIT AND EXPORT CUSTOMER FORM FOR THE JINESH (PROPERTY MANAGER)");
			...
			ngDriver.waitForAngularRequestsToFinish();
			System.out.println("Clicked on the User to Edit form field.");
		...
		title("VALIDATE THE EDIT BUTTON OF THE CUSTOM REPORT IN THE PROPERTY SUMMARY DASHBOARD - ADMIN USER");
		...
		try {
			...
			title("VALIDATE THE EDIT BUTTON OF THE CUSTOM REPORT IN THE PROPERTY SUMMARY DASHBOARD - PROPERTY MANAGER USER - JINESH");
		...
		try {
			...
			ngDriver.waitForAngularRequestsToFinish();
			System.out.println("Clicked on the Role to Edit form field.");
		...
		try {
			...
			title("VALIDATE THE EDIT BUTTON OF THE CUSTOM REPORT IN THE PROPERTY SUMMARY DASHBOARD - CONTRACTOR USER - JINESH CONTRACTOR");
		...
		try {
			...
			title("VALIDATE THE EDIT BUTTON OF THE CUSTOM REPORT IN THE PROPERTY SUMMARY DASHBOARD - HR USER - JINESH HR");

...
public class RR6237CustomForm1Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR6237CustomForm1Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR6237CustomForm1Test");

		// PERFORMED CRUD OPERATION OF THE CUSTOM FORMS FOR SINGLE RECORD TYPE.
		title("PERFORMED CRUD OPERATION OF THE CUSTOM FORMS FOR SINGLE RECORD TYPE.");

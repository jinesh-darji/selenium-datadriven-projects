...
public class RR6237CustomForm4Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR6237CustomForm4Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR6237CustomForm4Test");

		// ADD NEW PAGES IN THE CUSTOM RECORDS AND VALIDATE IN THE PORTFOLIO DASHBOARD -
		// SINGLE TYPE
		title("ADD NEW PAGES IN THE CUSTOM RECORDS AND VALIDATE IN THE PORTFOLIO DASHBOARD - SINGLE TYPE");
		...
		// UPDATE THE NEWLY CREATED PAGES OF THE CUSTOM FORMS
		title("UPDATE THE NEWLY CREATED PAGES OF THE CUSTOM FORMS");
		...
		try {
			...
			// click on the edit icon of the first page
			String editIcon1 = "//span[contains(text(),'" + pageName1
					+ "')]//a[@data-target='#updateSelectedTabPageNameModal']";
			driver.findElement(By.xpath(editIcon1)).click();
			consoleMessage("Clicked on the edit icon of the first page.");

			// update the page name
			type("customform_portfoliodashboard_pagename_editpagenametxt_XPATH", updatePageName1);

			// click on the save button
			click("customform_portfoliodashboard_pagename_editpagename_savebtn_XPATH");
			...
			try {
				String page11 = "//span[contains(text(),'" + updatePageName1 + "')]";
				String page11_actual = (driver.findElement(By.xpath(page11)).getText()).trim();

				if (page11_actual.equals(updatePageName1)) {
					successMessage("The updated page name is displayed successfully.");
				} else {
					verificationFailedMessage("The updated page name created page is not displayed.");
				}
			} catch (Throwable t) {
				verificationFailedMessage("The updated page name page is not displayed.");
			}
			...
			// click on the edit icon of the second page
			...
			// update the page name
			type("customform_portfoliodashboard_pagename_editpagenametxt_XPATH", updatePageName2);
			...
			try {
				String page22 = "//span[contains(text(),'" + updatePageName2 + "')]";
				String page22_actual = (driver.findElement(By.xpath(page22)).getText()).trim();

				if (page22_actual.equals(updatePageName2)) {
					successMessage("The updated page name is displayed successfully.");
				} else {
					verificationFailedMessage("The updated page name created page is not displayed.");
				}
		...
		// VALIDATE THE UPDATED PAGE NAME IS REFLECTED ON PORTFOLIO SUMMARY DASHBOARD
		// SCREEN
		title("VALIDATE THE UPDATED PAGE NAME IS REFLECTED ON PORTFOLIO SUMMARY DASHBOARD SCREEN");
		...
		try {
			...
			try {
				...
				if (updatePageTab1_actual.equals(updatePageName1)) {
					successMessage("The first updated page name is displayed successfully.");
				} else {
					verificationFailedMessage("The first updated page name is not displayed.");
				}
			} catch (Throwable t) {
				verificationFailedMessage("The first updated page name is not displayed.");
			}
			...
			try {
				...
				if (updatePageTab2_actual.equals(updatePageName2)) {
					successMessage("The second updated page name is displayed successfully.");
				} else {
					verificationFailedMessage("The second updated page name is not displayed.");
				}
			} catch (Throwable t) {
				verificationFailedMessage("The second updated page name is not displayed.");
			}
		...
		try {
			...
			String editIcon1 = "//span[contains(text(),'" + updatePageName1
			...
			String editIcon2 = "//span[contains(text(),'" + updatePageName2
					+ "')]//a[@ng-click='deleteSelectedTabPage(tabPage)']";
			driver.findElement(By.xpath(editIcon2)).click();

...
public class RR6462CustomForm10Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR6462CustomForm10Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR6462CustomForm10Test");

		// VALIDATE THE SECURITY PERMISSION OF INDIVIDUAL FIELDS OF THE GENERAL TAB AND
		// PAGES TAB/S FOR CUSTOM FORM - CORPORATE LEVEL.
		title("VALIDATE THE SECURITY PERMISSION OF INDIVIDUAL FIELDS OF THE GENERAL TAB AND PAGES TAB/S - CORPORATE LEVEL.");
		...
		try {
			...
			try {
				...
				if (customForm1_actual.equals(name)) {
					...
					// click on the record
					String fieldName = "//span[contains(text(),'" + field1Detail + "')]";
			...
			try {
				...
				try {
					...
					if (customForm1_actual.equals(name)) {
						...
						// click on the property one// scroll down the screen
						scrollBottom();

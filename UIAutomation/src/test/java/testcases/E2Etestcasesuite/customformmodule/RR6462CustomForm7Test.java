...
public class RR6462CustomForm7Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR6462CustomForm7Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR6462CustomForm7Test");

		// VALIDATE THE 'USER TO EXTRACT FORM' AND 'ROLE TO EXTRACT FORM' PERMISSIONS OF
		// THE CUSTOM FORMS - CORPORATE LEVEL.
		title("VALIDATE THE 'USER TO EXTRACT FORM' AND 'ROLE TO EXTRACT FORM' PERMISSIONS OF THE CUSTOM FORMS - CORPORATE LEVEL.");
		...
		try {
			...
			// from the property summary dashboard screen
			try {
				String customForm1 = "//td[text()='" + name + "']";
				String customForm1_actual = (driver.findElement(By.xpath(customForm1)).getText()).trim();

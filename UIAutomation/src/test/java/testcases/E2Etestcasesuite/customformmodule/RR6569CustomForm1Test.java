...
public class RR6569CustomForm1Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR6569CustomForm1Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR6569CustomForm1Test");

		// VERIFY THE LOCK DOWN PREVIOUS PERIOD FEATURE WITH SINGLE TYPE CUSTOM FORM.
		title("VERIFY THE LOCK DOWN PREVIOUS PERIOD FEATURE WITH SINGLE TYPE CUSTOM FORM.");
		...
		String fieldDetail1 = RandomStringUtils.randomAlphabetic(8); // Normal Field 1
		String fieldDetail2 = RandomStringUtils.randomNumeric(3); // Normal Field 2
		String pageFieldDetail1 = RandomStringUtils.randomAlphabetic(8); // Page Name 1 - Field 1
		String pageFieldDetail2 = RandomStringUtils.randomNumeric(3); // Page Name 1 - Field 2
		...
		title("VALIDATE THE EDIT FUNCTIONALITY WITH PAST EFFECTIVE DATE FOR THE LOCK DOWN PRERIOD WITH DIFFERENT DATES ON PORTFOLIO DASHBOARD");
		...
		// VALIDATE THE EDIT FUNCTIONALITY WITH PAST EFFECTIVE DATE FOR THE LOCK DOWN
		// PRERIOD WITH DIFFERENT DATES ON PROPERTY SUMMARY DASHBOARD
		title("VALIDATE THE EDIT FUNCTIONALITY WITH PAST EFFECTIVE DATE FOR THE LOCK DOWN PRERIOD WITH DIFFERENT DATES ON PROPERTY SUMMARY DASHBOARD");

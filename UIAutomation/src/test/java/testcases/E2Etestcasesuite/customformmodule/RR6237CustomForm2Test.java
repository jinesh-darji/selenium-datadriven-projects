...
public class RR6237CustomForm2Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR6237CustomForm2Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR6237CustomForm2Test");

		// ADD THE NEW FIELDS IN THE CUSTOM RECORDS AND VALIDATE IN THE PORTFOLIO
		// DASHBOARD - SINGLE TYPE
		title("ADD THE NEW FIELDS IN THE CUSTOM RECORDS AND VALIDATE IN THE PORTFOLIO DASHBOARD - SINGLE TYPE");
		...
		try {
			...
			// wait for the element
			explicitWait("customform_portfoliodashboard_propertyinformationtitle_XPATH");
			...
			// ADD THE DETAILS IN THE RESPECTIVE FIELDS
			title("ADD THE DETAILS IN THE RESPECTIVE FIELDS");
			...
			// UPDATE THE DETAILS IN THE RESPECTIVE FIELDS
			title("UPDATE THE DETAILS IN THE RESPECTIVE FIELDS");
			...
			driver.findElement(By.xpath(secondField)).sendKeys("456");
			consoleMessage("Entered the details in the second field.");
			...
			try {
				...
				if (thirdField11_actual.equals(today_string)) {
					...
					successMessage("The details of the third field is displayed as expected.");

				} else {

					verificationFailedMessage("The details of the third field is not displayed as expected.");

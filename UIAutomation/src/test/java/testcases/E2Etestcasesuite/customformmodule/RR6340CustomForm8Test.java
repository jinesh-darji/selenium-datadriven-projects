...
public class RR6340CustomForm8Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR6340CustomForm8Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR6340CustomForm8Test");

		// VALIDATE THE 'USER TO EDIT FORM' AND 'ROLE TO EDIT FORM' PERMISSIONS OF THE
		// CUSTOM FORMS - MULTIPLE TYPE.

		title("VALIDATE THE 'USER TO EDIT FORM' AND 'ROLE TO EDIT FORM' PERMISSIONS OF THE CUSTOM FORMS - MULTIPLE TYPE.");

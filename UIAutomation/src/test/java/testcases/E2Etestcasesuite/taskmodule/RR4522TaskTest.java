...
public class RR4522TaskTest extends TestBase {
	...
	public void rR4522TaskTest(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		System.out.println(
				"VERIFY THE TASK WITH TASK TAG PERMISSION (MODULE NAMES: ENVIRONMENT, ACCESS TO PO SECTION: USER-JINESH MISC 2 AND ROLE-MAINTENANCE).");
			...
			try {
				...
				try {
					...
					if (str1.equals("Test Task Tap Permission 3")) {
						...
						Assert.assertTrue(
								isElementPresent(
										By.xpath(OR.getProperty("task_createdtask_tasktagpermission33_XPATH"))),
								"The Test Task Tap Permission 3 is not displayed.");

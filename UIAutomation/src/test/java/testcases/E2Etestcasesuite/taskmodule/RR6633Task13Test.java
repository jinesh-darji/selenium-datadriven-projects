...
public class RR6633Task13Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR6633Task13Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR6633Task13Test");
		...
		// FORM“ BUTTON OF THE SINGLE TYPE CUSTOM FORM, AFTER APPLYING THE 'USER TO VIEW
		// FORM' AND 'ROLE TO VIEW FORM' PERMISSIONS TO THE SINGLE TYPE CUSTOM FORM.
		title("VALIDATE THE “JUMP TO CUSTOM FORM“ OPTION IN THE TASK (PROPERTY SUMMARY DASHBOARD "
				...
				+ "THE SINGLE TYPE CUSTOM FORM, AFTER APPLYING THE 'USER TO VIEW FORM' AND 'ROLE "
				+ "TO VIEW FORM' PERMISSIONS TO THE SINGLE TYPE CUSTOM FORM.");
		...
		String pageFieldDetail1 = RandomStringUtils.randomAlphabetic(8); // Page Detail 1 - Field 1
		...
		try {
			...
			// LAUNCHED ASSOCIATED SINGLE TYPE CUSTOM FORM WHICH WAS CREATED BY ADMIN USER -
			// PROPERTY MANAGER USER - JINESH
			title("VALIDATE THE JUMP SURVEY/INSPECTION/CUSTOM FORM BUTTON OF THE TASK (1) IS LAUNCHED ASSOCIATED SINGLE TYPE CUSTOM FORM WHICH WAS CREATED BY ADMIN USER - PROPERTY MANAGER USER - JINESH");
			...
			// CREATE THE NEW TASK (2) UNDER THE SINGLE TYPE CUSTOM FORM FROM PROPERTY
			// SUMMARY DASHBOARD - PROPERTY MANAGER USER - JINESH
			title("CREATE THE NEW TASK (2) UNDER THE SINGLE TYPE CUSTOM FORM FROM PROPERTY SUMMARY DASHBOARD - PROPERTY MANAGER USER - JINESH");
			...
			// VALIDATE THE NEWLY CREATED TASK (2) UNDER SINGLE TYPE CUSTOM FORM IN THE TASK
			// MODULE AND ASSOCIATE THE SAME TASK (2) WITH THE NEWLY CREATED SINGLE TYPE
			// CUSTOM FORM (PROPERTY SUMMARY DASHBOARD) - PROPERTY MANAGER USER - JINESH
			title("VALIDATE THE NEWLY CREATED TASK (2) UNDER SINGLE TYPE CUSTOM FORM IN THE TASK MODULE AND ASSOCIATE THE SAME TASK (2) WITH THE NEWLY CREATED SINGLE TYPE CUSTOM FORM (PROPERTY SUMMARY DASHBOARD) - PROPERTY MANAGER USER - JINESH");
			...
			// SINGLE TYPE CUSTOM FORM OF THE TASK (2) AND VALIDATE THE JUMP TO SINGLE TYPE
			// CUSTOM FORM OPTION OF THE SAME TASK (2) (PROPERTY SUMMARY DASHBOARD) -
			// PROPERTY MANAGER USER - JINESH
			title("VALIDATE THE JUMP SURVEY/INSPECTION/CUSTOM FORM BUTTON IS LAUNCHED ASSOCIATED SINGLE TYPE CUSTOM FORM OF THE TASK (2) AND VALIDATE THE JUMP TO SINGLE TYPE CUSTOM FORM OPTION OF THE SAME TASK (2) (PROPERTY SUMMARY DASHBOARD) - PROPERTY MANAGER USER - JINESH");
			...
			// CREATE THE NEW TASK (3) UNDER THE SINGLE TYPE CUSTOM FORM FROM PORTFOLIO
			// SUMMARY DASHBOARD - PROPERTY MANAGER USER - JINESH
			title("CREATE THE NEW TASK (3) UNDER THE SINGLE TYPE CUSTOM FORM FROM PORTFOLIO SUMMARY DASHBOARD - PROPERTY MANAGER USER - JINESH");
			...
			// VALIDATE THE NEWLY CREATED TASK (3) UNDER SINGLE TYPE CUSTOM FORM IN THE TASK
			// MODULE AND ASSOCIATE THE SAME TASK (3) WITH THE NEWLY CREATED SINGLE TYPE
			// CUSTOM FORM (PORTFOLIO SUMMARY DASHBOARD) - PROPERTY MANAGER USER - JINESH
			title("VALIDATE THE NEWLY CREATED TASK (3) UNDER SINGLE TYPE CUSTOM FORM IN THE TASK MODULE AND ASSOCIATE THE SAME TASK (3) WITH THE NEWLY CREATED SINGLE TYPE CUSTOM FORM (PORTFOLIO SUMMARY DASHBOARD) - PROPERTY MANAGER USER - JINESH");
			...
			// VALIDATE THE JUMP SURVEY/INSPECTION/CUSTOM FORM BUTTON IS LAUNCHED ASSOCIATED
			// SINGLE TYPE CUSTOM FORM OF THE TASK (3) AND VALIDATE THE JUMP TO SINGLE TYPE
			// CUSTOM FORM OPTION OF THE SAME TASK (3) (PORTFOLIO SUMMARY DASHBOARD) -
			// PROPERTY MANAGER USER - JINESH
			title("VALIDATE THE JUMP SURVEY/INSPECTION/CUSTOM FORM BUTTON IS LAUNCHED ASSOCIATED SINGLE TYPE CUSTOM FORM OF THE TASK (3) AND VALIDATE THE JUMP TO SINGLE TYPE CUSTOM FORM OPTION OF THE SAME TASK (3) (PORTFOLIO SUMMARY DASHBOARD) - PROPERTY MANAGER USER - JINESH");
		...
		try {
			...
			// VALIDATE THE JUMP SURVEY/INSPECTION/CUSTOM FORM BUTTON IS LAUNCHED ASSOCIATED
			// SINGLE TYPE CUSTOM FORM OF THE TASK (1) WHICH WAS CREATED BY ADMIN USER -
			// PROPERTY MANAGER USER - JINESH
			title("VALIDATE THE JUMP SURVEY/INSPECTION/CUSTOM FORM BUTTON IS LAUNCHED ASSOCIATED SINGLE TYPE CUSTOM FORM OF THE TASK (1) WHICH WAS CREATED BY ADMIN USER - PROPERTY MANAGER USER - JINESH");
			...
			// VALIDATE THE JUMP SURVEY/INSPECTION/CUSTOM FORM BUTTON OF THE SINGLE TYPE
			// CUSTOM FORM OF THE TASK (2) WHICH WAS CREATED UNDER SINGLE TYPE CUSTOM FORM
			// BY PROPERTY MANAGER USER - PROPERTY MANAGER USER - JINESH
			title("VALIDATE THE JUMP SURVEY/INSPECTION/CUSTOM FORM BUTTON OF THE SINGLE TYPE CUSTOM FORM OF THE TASK (2) WHICH WAS CREATED UNDER SINGLE TYPE CUSTOM FORM BY PROPERTY MANAGER USER - PROPERTY MANAGER USER - JINESH");
			...
			// VALIDATE THE JUMP TO SINGLE TYPE CUSTOM FORM OPTION OF THE TASK (2) WHICH WAS
			// CREATED BY PROPERTY MANAGER USER (PROPERTY SUMMARY DASHBOARD) - PROPERTY
			// MANAGER USER - JINESH
			title("VALIDATE THE JUMP TO SINGLE TYPE CUSTOM FORM OPTION OF THE TASK (2) WHICH WAS CREATED BY PROPERTY MANAGER USER (PROPERTY SUMMARY DASHBOARD) - PROPERTY MANAGER USER - JINESH");
			...
			// VALIDATE THE JUMP SURVEY/INSPECTION/CUSTOM FORM BUTTON OF THE SINGLE TYPE
			// CUSTOM FORM OF THE TASK (3) WHICH WAS CREATED UNDER SINGLE TYPE CUSTOM FORM
			// BY PROPERTY MANAGER USER (PORTFOLIO SUMMARY DASHBOARD) - PROPERTY MANAGER
			// USER - JINESH
			title("VALIDATE THE JUMP SURVEY/INSPECTION/CUSTOM FORM BUTTON OF THE SINGLE TYPE CUSTOM FORM OF THE TASK (3) WHICH WAS CREATED UNDER SINGLE TYPE CUSTOM FORM BY PROPERTY MANAGER USER (PORTFOLIO SUMMARY DASHBOARD) - PROPERTY MANAGER USER - JINESH");
			...
			// VALIDATE THE JUMP TO SINGLE TYPE CUSTOM FORM OPTION OF THE TASK (3) WHICH WAS
			// CREATED BY PROPERTY MANAGER USER (PORTFOLIO SUMMARY DASHBOARD) - PROPERTY
			// MANAGER USER - JINESH
			title("VALIDATE THE JUMP TO SINGLE TYPE CUSTOM FORM OPTION OF THE TASK (3) WHICH WAS CREATED BY PROPERTY MANAGER USER (PORTFOLIO SUMMARY DASHBOARD) - PROPERTY MANAGER USER - JINESH");
		...
		try {
			...
			title("VALIDATE THE JUMP SURVEY/INSPECTION/CUSTOM FORM BUTTON IS LAUNCHED ASSOCIATED SINGLE TYPE CUSTOM FORM OF THE TASK (1) WHICH WAS CREATED BY ADMIN USER - CONTRACTOR USER - JINESH CONTRACTOR\")");
			...
			// NEWLY CREATED SINGLE TYPE CUSTOM FORM (PROPERTY SUMMARY DASHBOARD) -
			// CONTRACTOR USER - JINESH CONTRACTOR
			title("VALIDATE THE NEWLY CREATED TASK (2) UNDER SINGLE TYPE CUSTOM FORM IN THE TASK MODULE BY PROPERTY MANAGER USER AND ASSOCIATE THE SAME TASK (2) WITH THE NEWLY CREATED SINGLE TYPE CUSTOM FORM (PROPERTY SUMMARY DASHBOARD) - CONTRACTOR USER - JINESH CONTRACTOR");
			...
			// CUSTOM FORM OPTION OF THE SAME TASK (2) (PROPERTY SUMMARY DASHBOARD) -
			// CONTRACTOR USER - JINESH CONTRACTOR
			title("VALIDATE THE JUMP SURVEY/INSPECTION/CUSTOM FORM BUTTON IS LAUNCHED ASSOCIATED SINGLE TYPE CUSTOM FORM OF THE TASK (2) AND VALIDATE THE JUMP TO SINGLE TYPE CUSTOM FORM OPTION OF THE SAME TASK (2) (PROPERTY SUMMARY DASHBOARD) - CONTRACTOR USER - JINESH CONTRACTOR");
			...
			// NEWLY CREATED SINGLE TYPE CUSTOM FORM (PORTFOLIO SUMMARY DASHBOARD) -
			// CONTRACTOR USER - JINESH CONTRACTOR
			title("VALIDATE THE NEWLY CREATED TASK (3) UNDER SINGLE TYPE CUSTOM FORM IN THE TASK MODULE BY PROPERTY MANAGER USER AND ASSOCIATE THE SAME TASK (3) WITH THE NEWLY CREATED SINGLE TYPE CUSTOM FORM (PORTFOLIO SUMMARY DASHBOARD) - CONTRACTOR USER - JINESH CONTRACTOR");
			...
			// CUSTOM FORM OPTION OF THE SAME TASK (3) (PORTFOLIO SUMMARY DASHBOARD) -
			// CONTRACTOR USER - JINESH CONTRACTOR
			title("VALIDATE THE JUMP SURVEY/INSPECTION/CUSTOM FORM BUTTON IS LAUNCHED ASSOCIATED SINGLE TYPE CUSTOM FORM OF THE TASK (3) AND VALIDATE THE JUMP TO SINGLE TYPE CUSTOM FORM OPTION OF THE SAME TASK (3) (PORTFOLIO SUMMARY DASHBOARD) - CONTRACTOR USER - JINESH CONTRACTOR");
		...
		try {
			...
			// VALIDATE THE NEWLY CREATED TASK UNDER SINGLE TYPE CUSTOM FORM IN THE TASK
			// MODULE BY PROPERTY MANAGER USER AND ASSOCIATE THE SAME TASK (2) WITH THE
			// NEWLY CREATED SINGLE TYPE CUSTOM FORM (PROPERTY SUMMARY DASHBOARD) -
			// CONTRACTOR USER - JINESH CONTRACTOR
			title("VALIDATE THE NEWLY CREATED TASK UNDER SINGLE TYPE CUSTOM FORM IN THE TASK MODULE BY PROPERTY MANAGER USER AND ASSOCIATE THE SAME TASK (2) WITH THE NEWLY CREATED SINGLE TYPE CUSTOM FORM (PROPERTY SUMMARY DASHBOARD) - CONTRACTOR USER - JINESH CONTRACTOR");
			...
			// NEWLY CREATED SINGLE TYPE CUSTOM FORM (PORTFOLIO SUMMARY DASHBOARD) -
			// CONTRACTOR USER - JINESH CONTRACTOR
			title("VALIDATE THE NEWLY CREATED TASK UNDER SINGLE TYPE CUSTOM FORM IN THE TASK MODULE BY PROPERTY MANAGER USER AND ASSOCIATE THE SAME TASK (3) WITH THE NEWLY CREATED SINGLE TYPE CUSTOM FORM (PORTFOLIO SUMMARY DASHBOARD) - CONTRACTOR USER - JINESH CONTRACTOR");
		...
		try {
			...
			// VALIDATE THE JUMP SURVEY/INSPECTION/CUSTOM FORM BUTTON IS LAUNCHED ASSOCIATED
			// SINGLE TYPE CUSTOM FORM OF THE TASK (1) WHICH WAS CREATED BY ADMIN USER - HR
			// USER - JINESH HR
			title("VALIDATE THE JUMP SURVEY/INSPECTION/CUSTOM FORM BUTTON IS LAUNCHED ASSOCIATED SINGLE TYPE CUSTOM FORM OF THE TASK (1) WHICH WAS CREATED BY ADMIN USER - HR USER - JINESH HR");
			...
			title("VALIDATE THE JUMP SURVEY/INSPECTION/CUSTOM FORM BUTTON OF THE SINGLE TYPE CUSTOM FORM OF THE TASK (2) WHICH WAS CREATED UNDER SINGLE TYPE CUSTOM FORM BY PROPERTY MANAGER USER - HR USER - JINESH HR");
			...
			// VALIDATE THE JUMP TO SINGLE TYPE CUSTOM FORM OPTION OF THE TASK (2) WHICH WAS
			// CREATED BY PROPERTY MANAGER USER (PROPERTY SUMMARY DASHBOARD) - HR USER -
			// JINESH HR
			title("VALIDATE THE JUMP TO SINGLE TYPE CUSTOM FORM OPTION OF THE TASK (2) WHICH WAS CREATED BY PROPERTY MANAGER USER (PROPERTY SUMMARY DASHBOARD) - HR USER - JINESH HR");
			...
			title("VALIDATE THE JUMP SURVEY/INSPECTION/CUSTOM FORM BUTTON OF THE SINGLE TYPE CUSTOM FORM OF THE TASK (3) WHICH WAS CREATED UNDER SINGLE TYPE CUSTOM FORM BY PORTFOLIO MANAGER USER - HR USER - JINESH HR");
			...
			// VALIDATE THE JUMP TO SINGLE TYPE CUSTOM FORM OPTION OF THE TASK (3) WHICH WAS
			// CREATED BY PROPERTY MANAGER USER (PORTFOLIO SUMMARY DASHBOARD) - HR USER -
			// JINESH HR
			title("VALIDATE THE JUMP TO SINGLE TYPE CUSTOM FORM OPTION OF THE TASK (3) WHICH WAS CREATED BY PROPERTY MANAGER USER (PORTFOLIO SUMMARY DASHBOARD) - HR USER - JINESH HR");

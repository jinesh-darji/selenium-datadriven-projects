...
public class RR4528TaskTest extends TestBase {
	...
	public void rR4528TaskTest(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		title("VERIFY THE TASK WITH TASK TAG PERMISSION (MODULE NAMES: ENVIRONMENT, ACCESS TO SURVEY/CHECKLIST SECTION: USER-JINESH MISC 2 AND ROLE-MAINTENANCE).");
		...
		try {
			...
			try {
				...
				if (str4 == true) {
					successMessage("The Survey/Checklist tab is displayed as expected.");
				} else {

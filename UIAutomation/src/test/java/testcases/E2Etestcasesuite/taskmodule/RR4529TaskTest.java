...
public class RR4529TaskTest extends TestBase {
	...
	public void rR4529TaskTest(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		System.out.println(
				"VERIFY THE TASK WITH TASK TAG PERMISSION (MODULE NAMES: ENVIRONMENT, ACCESS TO EDIT PO DETAILS: USER-JINESH MISC 2 AND ROLE-MAINTENANCE).");
		...
		try {
			...
			try {
				...
				if (str11 && str16 == true) {
					System.out.println("The PO Required checkbox is displayed as expected.");
					test.log(LogStatus.INFO, "The PO Required checkbox is displayed as expected.");
					Reporter.log("The PO Required checkbox is displayed as expected.");
					log.info("The PO Required checkbox is displayed as expected.");
				...
				// Extent Report
				test.log(LogStatus.FAIL, " The PO Required checkbox verification failure : ");
				test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));
			...
			try {
				...
				if (str12 && str17 == true) {
					System.out.println("The PO Approved checkbox is displayed as expected.");
					test.log(LogStatus.INFO, "The PO Approved checkbox is displayed as expected.");
					Reporter.log("The PO Approved checkbox is displayed as expected.");
					log.info("The PO Approved checkbox is displayed as expected.");
					...
					// Extent Report
					test.log(LogStatus.FAIL, " The PO Approved checkbox tab verification failure : ");
					test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));
			...
			try {
				...
				if (str18 && str13 == true) {
					System.out.println("The PO Number checkbox is displayed as expected.");
					test.log(LogStatus.INFO, "The PO Number checkbox is displayed as expected.");
					Reporter.log("The PO Number checkbox is displayed as expected.");
					log.info("The PO Number checkbox is displayed as expected.");
					...
					// Extent Report
					test.log(LogStatus.FAIL, " The PO Number checkbox tab verification failure : ");
					test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));
			...
			try {
				...
				if (str19 && str14 == true) {
					System.out.println("The Approved to Proceed checkbox is displayed as expected.");
					test.log(LogStatus.INFO, "The Approved to Proceed checkbox is displayed as expected.");
					Reporter.log("The Approved to Proceed checkbox is displayed as expected.");
					log.info("The Approved to Proceed checkbox is displayed as expected.");
				...
				// Extent Report
				test.log(LogStatus.FAIL, " The Approved to Proceed checkbox verification failure : ");
				test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));
			...
			try {
				...
				if (str20 && str15 == true) {
					System.out.println("The Estimate Required checkbox is displayed as expected.");
					test.log(LogStatus.INFO, "The Estimate Required checkbox is displayed as expected.");
					Reporter.log("The Estimate Required checkbox is displayed as expected.");
					log.info("The Estimate Required checkbox is displayed as expected.");
					...
					// Extent Report
					test.log(LogStatus.FAIL, " The Estimate Required checkbox tab verification failure : ");
					test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));
			...
			try {
				...
				if (str5 == true) {
					...
					System.out.println("The Estimated Amount field is not displayed as expected.");
					test.log(LogStatus.INFO, "The Estimated Amount field is not displayed as expected.");
					Reporter.log("The Estimated Amount field is not displayed as expected.");
					log.info("The Estimated Amount field is not displayed as expected.");
			...
			try {
				...
				try {
					...
					if (str1.equals("Test Task Tap Permission 5")) {
						...
						Assert.assertTrue(
								isElementPresent(
										By.xpath(OR.getProperty("task_createdtask_tasktagpermission55_XPATH"))),
								"The Test Task Tap Permission 5 is not displayed.");

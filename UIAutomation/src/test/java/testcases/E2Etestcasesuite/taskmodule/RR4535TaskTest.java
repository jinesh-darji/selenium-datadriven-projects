...
public class RR4535TaskTest extends TestBase {
	...
	public void rR4535TaskTest(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		title("VERIFY THE TASK WITH TASK TAG PERMISSION (MODULE NAMES: ENVIRONMENT, ACCESS TO EDIT PO ESTIMATION AMOUNT FIELD: USER-JINESH MISC 2 AND ROLE-MAINTENANCE).");
		...
		try {
			...
			try {
				...
				if (str5 == true) {
					...
					successMessage("The Estimated Amount field is displayed editable as expected.");

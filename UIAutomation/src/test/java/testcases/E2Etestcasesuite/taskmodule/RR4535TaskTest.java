...
public class RR4535TaskTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR4535TaskTest(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR4535TaskTest");

		// VERIFY THE TASK WITH TASK TAG PERMISSION (MODULE NAMES: ENVIRONMENT, ACCESS
		// TO EDIT PO ESTIMATION AMOUNT FIELD: USER-JINESH MISC 2 AND ROLE-MAINTENANCE)

		System.out.println(
				"VERIFY THE TASK WITH TASK TAG PERMISSION (MODULE NAMES: ENVIRONMENT, ACCESS TO EDIT PO ESTIMATION AMOUNT FIELD: USER-JINESH MISC 2 AND ROLE-MAINTENANCE).");
		...
		try {
			...
			switchVerification("task_createdtask_tasktagpermission77_XPATH", "Test Task Tap Permission 7",
					"The Test Task Tap Permission 7 is not displayed.");
		...
		try {
			...
			try {
				...
				click("task_createdtask_tasktagpermission77_XPATH");
				ngDriver.waitForAngularRequestsToFinish();
			...
			try {
				...
				if (str5 == true) {
					...
					System.out.println("The Estimated Amount field is displayed editable as expected.");
					test.log(LogStatus.INFO, "The Estimated Amount field is disabled editable as expected.");
					Reporter.log("The Estimated Amount field is displayed editable as expected.");
					log.info("The Estimated Amount field is displayed editable as expected.");
			...
			try {
				...
				if (str8 == true) {
					...
					System.out.println("The Estimated Amount field is displayed editable as expected.");
					test.log(LogStatus.INFO, "The Estimated Amount field is displayed editable as expected.");
					Reporter.log("The Estimated Amount field is displayed editable as expected.");
					log.info("The Estimated Amount field is displayed editable as expected.");
			...
			try {
				...
				try {
					String str1 = driver
							.findElement(By.xpath(OR.getProperty("task_createdtask_tasktagpermission77_XPATH")))
							.getText();
					ngDriver.waitForAngularRequestsToFinish();
					if (str1.equals("Test Task Tap Permission 7")) {

						Assert.assertTrue(
								isElementPresent(
										By.xpath(OR.getProperty("task_createdtask_tasktagpermission77_XPATH"))),
								"The Test Task Tap Permission 7 is not displayed.");
		...
		try {
			...
			helper.deleteVerification("task_createdtask_tasktagpermission77_XPATH", "Test Task Tap Permission 7");

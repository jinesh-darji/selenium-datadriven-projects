...
public class RR6633Task7Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR6633Task7Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR6633Task7Test");

		// VALIDATE THE “JUMP TO CUSTOM FORM“ OPTION WHEN THE TASK WAS CREATED UNDER THE
		// SINGLE TYPE CUSTOM FORM AND VALIDATE THE NAVIGATION OF THE “JUMP
		// SURVEY/INSPECTION/CUSTOM FORM“ BUTTON AFTER ASSOCIATING THE MULTIPLE TYPE
		// CUSTOM FORM WITH THE SAME TASK.
		title("VALIDATE THE “JUMP TO CUSTOM FORM“ OPTION WHEN THE TASK WAS CREATED UNDER THE SINGLE TYPE CUSTOM FORM AND VALIDATE THE NAVIGATION OF THE “JUMP SURVEY/INSPECTION/CUSTOM FORM“ BUTTON AFTER ASSOCIATING THE MULTIPLE TYPE CUSTOM FORM WITH THE SAME TASK.");
		...
		// VALIDATE THE NEWLY CREATED TASK UNDER SINGLE TYPE CUSTOM FOR IN THE TASK
		// MODULE AND ASSOCIATE THE SAME TASK WITH THE NEWLY CREATED MULTIPLE TYPE
		// CUSTOM FORM (PROPERTY SUMMARY DASHBOARD)
		title("VALIDATE THE NEWLY CREATED TASK UNDER SINGLE TYPE CUSTOM FOR IN THE TASK MODULE AND ASSOCIATE THE SAME TASK WITH THE NEWLY CREATED MULTIPLE TYPE CUSTOM FORM (PROPERTY SUMMARY DASHBOARD)");
		...
		try {
			...
			select("survey_task_questionnairedd_CSS", name_m);
		...
		// MULTIPLETYPE CUSTOM FORM OF THE TASK AND VALIDATE THE JUMP TO SINGLE TYPE
		// CUSTOM FORM OPTION OF THE SAME TASK (PROPERTY SUMMARY DASHBOARD)
		title("VALIDATE THE JUMP SURVEY/INSPECTION/CUSTOM FORM BUTTON IS LAUNCHED ASSOCIATED MULTIPLETYPE CUSTOM FORM OF THE TASK AND VALIDATE THE JUMP TO SINGLE TYPE CUSTOM FORM OPTION OF THE SAME TASK (PROPERTY SUMMARY DASHBOARD)");
		...
		try {
			...
			try {
				String selectedQuestionnaire = "//option[@label='" + name_m + "' and @selected='selected']";
			...
			for (int m = 0; m < count_m; m++) {
				...
				// validate the details of the first field
				try {
					consoleMessage(field1Detail_list_m.get(m));
					String firstField1 = "//span[contains(text(),'" + field1Detail_list_m.get(m) + "')]";
					String firstField1_actual = (driver.findElement(By.xpath(firstField1)).getText()).trim();

					if (firstField1_actual.equals(field1Detail_list_m.get(m))) {
						successMessage("The details of the first field is displayed successfully.");
					} else {
						verificationFailedMessage("The details of the first field is not displayed.");
					}
				...
				// validate the details of the second field
				try {
					consoleMessage(field2Detail_list_m.get(m));
					String secondField1 = "//span[contains(text(),'" + field2Detail_list_m.get(m) + "')]";
					String secondField1_actual = (driver.findElement(By.xpath(secondField1)).getText()).trim();

					if (secondField1_actual.equals(field2Detail_list_m.get(m))) {
						successMessage("The details of the second field is displayed successfully.");
					} else {
						verificationFailedMessage("The details of the second field is not displayed.");
					}
				...
				// validate the details of the first field of page one
				try {
					consoleMessage(pageField1Detail_list_m.get(m));
					String firstField1 = "//span[contains(text(),'" + pageField1Detail_list_m.get(m) + "')]";
					String firstField1_actual = (driver.findElement(By.xpath(firstField1)).getText()).trim();

					if (firstField1_actual.equals(pageField1Detail_list_m.get(m))) {
						successMessage("The details of the first field of page one is displayed successfully.");
					} else {
						verificationFailedMessage("The details of the first field of page one is not displayed.");
					}
				...
				// validate the details of the second field of page one
				try {
					consoleMessage(pageField2Detail_list_m.get(m));
					String secondField1 = "//span[contains(text(),'" + pageField2Detail_list_m.get(m) + "')]";
					String secondField1_actual = (driver.findElement(By.xpath(secondField1)).getText()).trim();

					if (secondField1_actual.equals(pageField2Detail_list_m.get(m))) {
						successMessage("The details of the second field of page one is displayed successfully.");
					} else {
						verificationFailedMessage("The details of the second field of page one is not displayed.");
					}
		...
		// DASHBOARD AND ASSOCIATE THE SAME TASK WITH THE NEWLY CREATED SINGLE TYPE
		// CUSTOM FORM
		title("CREATE THE NEW TASK UNDER THE SINGLE TYPE CUSTOM FORM FROM PORTFOLIO SUMMARY DASHBOARD AND ASSOCIATE THE SAME TASK WITH THE NEWLY CREATED SINGLE TYPE CUSTOM FORM");
		...
		title("VALIDATE THE NEWLY CREATED TASK UNDER SINGLE TYPE CUSTOM FOR IN THE TASK MODULE AND ASSOCIATE THE SAME TASK WITH THE NEWLY CREATED MULTIPLE TYPE CUSTOM FORM (PORTFOLIO SUMMARY DASHBOARD)");

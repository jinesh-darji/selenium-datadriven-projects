...
public class RR6576RiskManagement3Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR6576RiskManagement3Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR6576RiskManagement3Test");
		...
		// VERIFY THE NEW REVISION FEATURE OF THE INSURANCE POLICY.
		title("VERIFY THE NEW REVISION FEATURE OF THE INSURANCE POLICY.");
		...
		LocalDate revisioneffectivedate = LocalDate.now().plusMonths(1);
		String revisioneffectivedate_string = revisioneffectivedate.toString();
		LocalDate revisionexpirydate = LocalDate.now().plusMonths(2);
		String revisionexpirydate_string = revisionexpirydate.toString();
		...
		// ADD NEW REVISION FOR THE INSURANCE POLICY
		title("ADD NEW REVISION FOR THE INSURANCE POLICY");
		...
		try {
			...
			click("riskmanagement_insurancepolicies_newrevisionbtn_XPATH");

			// enter the revision date in the effective date field
			type("riskmanagement_insurancepolicies_revisionpolicy_effectivedatetxt_XPATH",
					revisioneffectivedate_string);

			// enter the revision date in the expiry date field
			type("riskmanagement_insurancepolicies_revisionpolicy_expirydatetxt_XPATH", revisionexpirydate_string);

			// click on the revision button
			click("riskmanagement_insurancepolicies_revisionpolicy_revisionbtn_XPATH");

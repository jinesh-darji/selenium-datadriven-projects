...
public class RR6501Environmental4Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR6501Environmental4Test(Hashtable<String, String> data) throws InterruptedException, IOException {

		execution(data, "rR6501Environmental4Test");
		...
		// ENVIRONMENTAL REPORT SCREENS
		title("KEEP ENVIRONMENTAL REPORT DATE FIELD OPTIONAL IN THE ENVIRONMENTAL FORMS AND ENVIRONMENTAL REPORT SCREENS");

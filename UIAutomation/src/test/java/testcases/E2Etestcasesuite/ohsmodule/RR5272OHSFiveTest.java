...
public class RR5272OHSFiveTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR5272OHSFiveTest(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR5272OHSFiveTest");

		// ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: PM

		System.out.println("********** ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: PM **********");
		test.log(LogStatus.INFO, "********** ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: PM **********");
		Reporter.log("********** ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: PM **********");
		log.info("********** ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: PM **********");
		...
		// ADD NEW ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: PM

		System.out.println("********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: PM **********");
		test.log(LogStatus.INFO,
				"********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: PM **********");
		Reporter.log("********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: PM **********");
		log.info("********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: PM **********");
		...
		try {
			...
			switchVerification("ohs_incident_alertnotification_addedincidentreport5_XPATH",
					"Describe Incident Text Alert Notification Five",
					"The Describe Incident Text Alert Notification Five is not displayed successfully.");
		...
		try {
			...
			click("ohs_incident_alertnotification_addedincidentreport5_XPATH");
			...
			// verification of the incident report is added or not
			switchVerification("ohs_incident_alertnotification_updatedincidentreport5_XPATH",
					"Update Describe Incident Text Alert Notification Five",
					"The Update Describe Incident Text Alert Notification Five is not displayed successfully.");
		...
		try {
			// click on the newly created incident report
			click("ohs_incident_alertnotification_updatedincidentreport5_XPATH");
			System.out.println("Clicked on the newly created incident report.");
			ngDriver.waitForAngularRequestsToFinish();
			System.out.println("Naviagte to the Update Incident record Screen.");
			...
			helper.deleteVerification("ohs_incident_alertnotification_updatedincidentreport5_XPATH",
					"Update Describe Incident Text Alert Notification Five");

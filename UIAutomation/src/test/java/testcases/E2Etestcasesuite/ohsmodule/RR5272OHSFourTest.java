...
public class RR5272OHSFourTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR5272OHSFourTest(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR5272OHSFourTest");

		// ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: ALL DAY

		System.out.println("********** ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: ALL DAY **********");
		test.log(LogStatus.INFO,
				"********** ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: ALL DAY **********");
		Reporter.log("********** ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: ALL DAY **********");
		log.info("********** ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: ALL DAY **********");
		...
		// ADD NEW ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: ALL DAY

		System.out.println(
				"********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: ALL DAY **********");
		test.log(LogStatus.INFO,
				"********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: ALL DAY **********");
		Reporter.log("********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: ALL DAY **********");
		log.info("********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: ALL DAY **********");
		...
		try {
			...
			switchVerification("ohs_incident_alertnotification_addedincidentreport4_XPATH",
					"Describe Incident Text Alert Notification Four",
					"The Describe Incident Text Alert Notification Four is not displayed successfully.");
		...
		try {
			...
			click("ohs_incident_alertnotification_addedincidentreport4_XPATH");
			...
			// verification of the incident report is added or not
			switchVerification("ohs_incident_alertnotification_updatedincidentreport4_XPATH",
					"Update Describe Incident Text Alert Notification Four",
					"The Update Describe Incident Text Alert Notification Four is not displayed successfully.");
		...
		try {
			// click on the newly created incident report
			click("ohs_incident_alertnotification_updatedincidentreport4_XPATH");
			System.out.println("Clicked on the newly created incident report.");
			ngDriver.waitForAngularRequestsToFinish();
			System.out.println("Naviagte to the Update Incident record Screen.");
			...
			helper.deleteVerification("ohs_incident_alertnotification_updatedincidentreport4_XPATH",
					"Update Describe Incident Text Alert Notification Four");

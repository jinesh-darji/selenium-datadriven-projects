...
public class RR5272OHSFourTest extends TestBase {
	...
	public void rR5272OHSFourTest(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		title("ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: ALL DAY");
		...
		title("ADD NEW ALERT NOTIFICATION - ALERT TYPE: EDIT AND TIME OF DAY: ALL DAY");
		...
		title("UPDATE THE NEWLY CREATED INCIDENT REPORT");
		...
		title("DELETE THE NEWLY UPDATED REPORT");

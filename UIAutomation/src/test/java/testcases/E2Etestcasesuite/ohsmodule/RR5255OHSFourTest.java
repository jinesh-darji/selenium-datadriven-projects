...
public class RR5255OHSFourTest extends TestBase {
	...
	public void rR5255OHSFourTest(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		title("SECURITY SETTING CONTROLS TO MAKE SURE THE ACCESS TO MODIFY INSURANCE STATUS IN INCIDENT REPORT CAN BE ONLY PERFORMED BY THE USER/ROLE WITH ACCESS TO IT.");
		...
		title("APPLY THE ACCESS TO MODIFY INSURANCE STATUS IN INCIDENT REPORT PERMISSION");
		...
		try {
			...
			title("VERIFY THE INSURANCE STATUS IS ACCESS IN JINESH USER OR NOT");
			...
			try {
				...
				try {
					...
					if (ss1 == true) {
						successMessage("The Insurance Status field is display enabled as expected.");

					} else {
						verificationFailedMessage("The Insurance Status field is display disabled.");
					}
			...
			title("VERIFY THE INSURANCE STATUS IN THE CONTRACTOR ROLE");
			...
			title("VERIFY THE INSURANCE STATUS ACCESS IN THE JINESH HR");
			...
			try {
				...
				try {
					...
					if (ss3 == true) {
						verificationFailedMessage("The Insurance Status field is display enabled without permission.");
					} else {
						successMessage("The Insurance Status field is display disabled as expected.");
					}
				} catch (Throwable t) {
					successMessage("The Insurance Status field is display disabled as expected.");
				}

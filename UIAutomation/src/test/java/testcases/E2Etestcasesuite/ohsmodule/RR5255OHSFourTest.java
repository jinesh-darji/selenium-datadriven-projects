...
public class RR5255OHSFourTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR5255OHSFourTest(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR5255OHSFourTest");

		// SECURITY SETTING CONTROLS TO MAKE SURE THE ACCESS TO MODIFY INSURANCE STATUS
		// IN INCIDENT REPORT CAN BE ONLY PERFORMED BY THE USER/ROLE WITH ACCESS TO IT.

		System.out.println(
				"SECURITY SETTING CONTROLS TO MAKE SURE THE ACCESS TO MODIFY INSURANCE STATUS IN INCIDENT REPORT CAN BE ONLY PERFORMED BY THE USER/ROLE WITH ACCESS TO IT.");
		...
		// APPLY THE ACCESS TO MODIFY INSURANCE STATUS IN INCIDENT REPORT PERMISSION

		System.out.println(
				"********** APPLY THE ACCESS TO MODIFY INSURANCE STATUS IN INCIDENT REPORT PERMISSION **********");
		test.log(LogStatus.INFO,
				"********** APPLY THE ACCESS TO MODIFY INSURANCE STATUS IN INCIDENT REPORT PERMISSION **********");
		Reporter.log("********** APPLY THE ACCESS TO MODIFY INSURANCE STATUS IN INCIDENT REPORT PERMISSION **********");
		log.info("********** APPLY THE ACCESS TO MODIFY INSURANCE STATUS IN INCIDENT REPORT PERMISSION **********");
		...
		try {
			...
			// APPLY THE ACCESS TO MODIFY Insurance STATUS IN INCIDENT REPORT PERMISSION
			helper.addPermissionOneUsersRole(data, "ohs_security_setting_1", "ohs_securitysettings4_XPATH");
		...
		try {
			...
			switchVerification("ohs_incident_addedincidentreport44_XPATH",
					"Describe Incident Text SS Four Testing Purpose",
					"The Describe Incident Text SS Four Testing Purpose is not displayed successfully.");
		...
		try {
			...
			// VERIFY THE INSURANCE STATUS IS ACCESS IN JINESH USER OR NOT
			...
			Reporter.log(
					"**************** VERIFY THE INSURANCE STATUS IS ACCESS IN JINESH USER OR NOT ****************");
			log.info("**************** VERIFY THE INSURANCE STATUS IS ACCESS IN JINESH USER OR NOT ****************");
			...
			try {
				...
				click("ohs_incident_addedincidentreport44_XPATH");
				ngDriver.waitForAngularRequestsToFinish();
				System.out.println("Clicked on the incident report.");

				try {
					boolean ss1 = driver
							.findElement(By.cssSelector(OR.getProperty("ohs_incident_ss_insurancestatustxt_CSS")))
							.isEnabled();

					if (ss1 == true) {

						System.out.println("The Insurance Status field is display enabled as expected.");
						test.log(LogStatus.INFO, "The Insurance Status field is display enabled as expected.");
						Reporter.log("The Insurance Status field is display enabled as expected.");
						log.info("The Insurance Status field is display enabled as expected.");

					} else {
						TestUtil.captureScreenshot();

						// ReportNG
						Reporter.log("<br>" + " The Insurance Status field is display disabled : " + "<br>");
						...
						// Extent Report
						test.log(LogStatus.FAIL, " The Insurance Status field is display disabled : ");
						test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));

						System.out.println("The Insurance Status field is display disabled.");
						log.info("The Insurance Status field is display disabled.");
					}
			...
			// VERIFY THE INSURANCE STATUS IN THE CONTRACTOR ROLE

			System.out.println(
					"**************** VERIFY THE INSURANCE STATUS IS ACCESS IN THE CONTRACTOR ROLE ****************");
			test.log(LogStatus.INFO,
					"**************** VERIFY THE INSURANCE STATUS IS ACCESS IN THE CONTRACTOR ROLE ****************");
			Reporter.log(
					"**************** VERIFY THE INSURANCE STATUS IS ACCESS IN THE CONTRACTOR ROLE ****************");
			log.info("**************** VERIFY THE INSURANCE STATUS IS ACCESS IN THE CONTRACTOR ROLE ****************");
			...
			// VERIFY THE INSURANCE STATUS ACCESS IN THE CONTRACTOR ROLE

			System.out.println("**************** VERIFY THE INSURANCE STATUS ACCESS IN THE JINESH HR ****************");
			test.log(LogStatus.INFO,
					"**************** VERIFY THE INSURANCE STATUS ACCESS IN THE JINESH HR ****************");
			Reporter.log("**************** VERIFY THE INSURANCE STATUS ACCESS IN THE JINESH HR ****************");
			log.info("**************** VERIFY THE INSURANCE STATUS ACCESS IN THE JINESH HR ****************");
			...
			try {
				...
				try {
					...
					if (ss3 == true) {
						...
						// ReportNG
						Reporter.log("<br>" + " The Insurance Status field is display enabled without permission: "
								+ "<br>");
						Reporter.log("<a target=\"_blank\" href=" + TestUtil.screenshotName + "><img src="
								+ TestUtil.screenshotName + " height=200 width=200></img></a>");
						Reporter.log("<br>");
						...
						// Extent Report
						test.log(LogStatus.FAIL, " The Insurance Status field is display enabled without permission: ");
						test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));

						System.out.println("The Insurance Status field is display enabled without permission.");
						log.info("The Insurance Status field is display enabled without permission.");

					} else {
						System.out.println("The Insurance Status field is display disabled as expected.");
						test.log(LogStatus.INFO, "The Insurance Status field is display disabled as expected.");
						Reporter.log("The Insurance Status field is display disabled as expected.");
						log.info("The Insurance Status field is display disabled as expected.");
		...
		try {
			...
			helper.deleteVerification("ohs_incident_addedincidentreport44_XPATH",
					"Describe Incident Text SS Four Testing Purpose");
		...
		try {
			...
			helper.resetPermission(data, "ohs_security_setting_1", "ohs_securitysettings4_XPATH");

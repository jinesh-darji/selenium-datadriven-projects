...
public class RR5298OHSThreeTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR5298OHSThreeTest(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR5298OHSThreeTest");

		// ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: AM (Administration >
		// OHS)

		System.out.println(
				"********** ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: AM (Administration > OHS) **********");
		...
		try {
			...
			System.out.println("Clicked on the Incident Event Types option.");
			ngDriver.waitForAngularRequestsToFinish();
			...
			ngDriver.waitForAngularRequestsToFinish();
			System.out.println("Typed details in the description field.");
			...
			switchVerification("ohs_incident_alertnotification_incidenteventype_addedrecord3_XPATH",
					"Short Description SS OHS Three for Testing Purpose",
					"The Short Description SS OHS Three for Testing Purpose is not displayed.");
		...
		try {
			...
			switchVerification("ohs_incident_alertnotification_addedincidentreportohs3_XPATH",
					"Describe Incident Text Alert Notification OHS Three",
					"The Describe Incident Text Alert Notification OHS Three is not displayed successfully.");
		...
		try {
			...
			click("ohs_incident_alertnotification_addedincidentreportohs3_XPATH");
			...
			helper.deleteVerification("ohs_incident_alertnotification_addedincidentreportohs3_XPATH",
					"Describe Incident Text Alert Notification OHS Three");
		...
		try {
			...
			click("ohs_incident_alertnotification_incidenteventype_addedrecord3_XPATH");
			ngDriver.waitForAngularRequestsToFinish();
			System.out.println("Clicked on newly added incident email notification.");
			...
			helper.deleteVerification("ohs_incident_alertnotification_incidenteventype_addedrecord3_XPATH",
					"Short Description SS OHS Three for Testing Purpose");

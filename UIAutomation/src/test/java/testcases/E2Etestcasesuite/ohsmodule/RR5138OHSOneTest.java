...
public class RR5138OHSOneTest extends TestBase {
	...
	public void rR5138OHSOneTest(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		System.out.println("NUMBER OF TASKS ON THE OHS PROPERTY LANDING PAGE. (WHICH ARE DUE IN 30 DAYS)");
		test.log(LogStatus.INFO, "NUMBER OF TASKS ON THE OHS PROPERTY LANDING PAGE. (WHICH ARE DUE IN 30 DAYS)");
		Reporter.log("NUMBER OF TASKS ON THE OHS PROPERTY LANDING PAGE. (WHICH ARE DUE IN 30 DAYS)");
		log.info("NUMBER OF TASKS ON THE OHS PROPERTY LANDING PAGE. (WHICH ARE DUE IN 30 DAYS)");
		...
		try {
			...
			if (thirtydaystaskcount1.equals(stringtask1)) {
				...
				// ReportNG
				Reporter.log("<br>" + "The task's count is displayed after deleted the incident report : " + "<br>");
				Reporter.log("<a target=\"_blank\" href=" + TestUtil.screenshotName + "><img src="
						+ TestUtil.screenshotName + " height=200 width=200></img></a>");
				Reporter.log("<br>");
				Reporter.log("<br>");
				...
				// Extent Report
				test.log(LogStatus.FAIL, " The task's count is displayed after deleted the incident report : ");
				test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));

				System.out.println("The task's count is displayed after deleted the incident report.");
				log.info("The task's count is displayed after deleted the incident report.");
			}
		} catch (Throwable t) {

			System.out.println("The task's count is not displayed as expected.");
			test.log(LogStatus.INFO, "The task's count is not displayed as expected.");
			Reporter.log("The task's count is not displayed as expected.");
			log.info("The task's count is not displayed as expected.");

...
public class RR5298OHSOneTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR5298OHSOneTest(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR5298OHSOneTest");

		// ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: ALL DAY (Administration
		// > OHS)

		System.out.println(
				"********** ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: ALL DAY (Administration > OHS) **********");
		...
		try {
			...
			switchVerification("ohs_incident_alertnotification_incidenteventype_addedrecord1_XPATH",
					"Short Description SS OHS One for Testing Purpose",
					"The Short Description SS OHS One for Testing Purpose is not displayed.");
		...
		try {
			...
			switchVerification("ohs_incident_alertnotification_addedincidentreportohs1_XPATH",
					"Describe Incident Text Alert Notification OHS One",
					"The Describe Incident Text Alert Notification OHS One is not displayed successfully.");
		...
		try {
			...
			click("ohs_incident_alertnotification_addedincidentreportohs1_XPATH");
			...
			helper.deleteVerification("ohs_incident_alertnotification_addedincidentreportohs1_XPATH",
					"Describe Incident Text Alert Notification OHS One");
		...
		try {
			...
			click("ohs_incident_alertnotification_incidenteventype_addedrecord1_XPATH");
			ngDriver.waitForAngularRequestsToFinish();
			...
			helper.deleteVerification("ohs_incident_alertnotification_incidenteventype_addedrecord1_XPATH",
					"Short Description SS OHS One for Testing Purpose");

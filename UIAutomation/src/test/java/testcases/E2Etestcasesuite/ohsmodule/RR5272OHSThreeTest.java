...
public class RR5272OHSThreeTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR5272OHSThreeTest(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR5272OHSThreeTest");

		// ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: AM

		System.out.println("********** ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: AM **********");
		test.log(LogStatus.INFO, "********** ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: AM **********");
		Reporter.log("********** ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: AM **********");
		log.info("********** ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: AM **********");
		...
		// ADD NEW ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: AM

		System.out.println("********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: AM **********");
		test.log(LogStatus.INFO,
				"********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: AM **********");
		Reporter.log("********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: AM **********");
		log.info("********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: AM **********");
		...
		try {
			...
			switchVerification("ohs_incident_alertnotification_addedincidentreport3_XPATH",
					"Describe Incident Text Alert Notification Three",
					"The Describe Incident Text Alert Notification Three is not displayed successfully.");
		...
		try {
			...
			click("ohs_incident_alertnotification_addedincidentreport3_XPATH");
			...
			helper.deleteVerification("ohs_incident_alertnotification_addedincidentreport3_XPATH",
					"Describe Incident Text Alert Notification Three");

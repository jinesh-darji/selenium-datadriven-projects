...
public class RR5272OHSTwoTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR5272OHSTwoTest(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR5272OHSTwoTest");

		// ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: PM

		System.out.println("********** ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: PM **********");
		test.log(LogStatus.INFO, "********** ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: PM **********");
		Reporter.log("********** ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: PM **********");
		log.info("********** ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: PM **********");
		...
		// ADD NEW ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: PM

		System.out.println("********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: PM **********");
		test.log(LogStatus.INFO,
				"********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: PM **********");
		Reporter.log("********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: PM **********");
		log.info("********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: PM **********");
		...
		try {
			...
			switchVerification("ohs_incident_alertnotification_addedincidentreport2_XPATH",
					"Describe Incident Text Alert Notification Two",
					"The Describe Incident Text Alert Notification Two is not displayed successfully.");
		...
		try {
			...
			click("ohs_incident_alertnotification_addedincidentreport2_XPATH");
			...
			helper.deleteVerification("ohs_incident_alertnotification_addedincidentreport2_XPATH",
					"Describe Incident Text Alert Notification Two");

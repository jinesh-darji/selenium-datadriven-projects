...
public class RR5255OHSFiveTest extends TestBase {
	...
	public void rR5255OHSFiveTest(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		title("SECURITY SETTING CONTROLS TO MAKE SURE THE ACCESS TO MOVE INCIDENT REPORTS CAN BE ONLY PERFORMED BY THE USER/ROLE WITH ACCESS TO IT.");
		...
		title("APPLY THE ACCESS TO MOVE INCIDENT REPORTS PERMISSION");
		...
		try {
			...
			title("VERIFY THE MOVE BUTTON IS DISPLAY IN JINESH USER OR NOT");
			...
			try {
				...
				try {
					...
					if (ss1 == true) {
						successMessage("The Move Button is display as expected.");

					} else {
						verificationFailedMessage("The Move Button is not display.");
					}
				} catch (Throwable t) {
					verificationFailedMessage("The Move Button is not display.");
				}
			...
			title("VERIFY THE MOVE BUTTON IS DISPLAY IN THE CONTRACTOR ROLE");
			...
			try {
				...
				try {
					...
					if (ss3 == true) {
						verificationFailedMessage("The Move Button is display without the permission.");
					} else {
						successMessage("The Move Button is not display as expected.");
					}

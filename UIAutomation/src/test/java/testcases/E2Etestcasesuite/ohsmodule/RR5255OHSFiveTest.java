...
public class RR5255OHSFiveTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR5255OHSFiveTest(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR5255OHSFiveTest");

		// SECURITY SETTING CONTROLS TO MAKE SURE THE ACCESS TO MOVE INCIDENT REPORTS
		// CAN BE ONLY PERFORMED BY THE USER/ROLE WITH ACCESS TO IT.

		System.out.println(
				"SECURITY SETTING CONTROLS TO MAKE SURE THE ACCESS TO MOVE INCIDENT REPORTS CAN BE ONLY PERFORMED BY THE USER/ROLE WITH ACCESS TO IT.");
		...
		// APPLY THE ACCESS TO MOVE INCIDENT REPORTS PERMISSION

		System.out.println("********** APPLY THE ACCESS TO MOVE INCIDENT REPORTS PERMISSION **********");
		test.log(LogStatus.INFO, "********** APPLY THE ACCESS TO MOVE INCIDENT REPORTS PERMISSION **********");
		Reporter.log("********** APPLY THE ACCESS TO MOVE INCIDENT REPORTS PERMISSION **********");
		log.info("********** APPLY THE ACCESS TO MOVE INCIDENT REPORTS PERMISSION **********");
		...
		try {
			...
			// APPLY THE Access to Move Incident Reports PERMISSION
			helper.addPermissionOneUsersRole(data, "ohs_security_setting_1", "ohs_securitysettings5_XPATH");
		...
		try {
			...
			switchVerification("ohs_incident_addedincidentreport55_XPATH",
					"Describe Incident Text SS Five Testing Purpose",
					"The Describe Incident Text SS Five Testing Purpose is not displayed successfully.");
		...
		try {
			...
			// VERIFY THE MOVE BUTTON IS DISPLAY IN JINESH USER OR NOT

			System.out.println(
					"**************** VERIFY THE MOVE BUTTON IS DISPLAY IN JINESH USER OR NOT ****************");
			test.log(LogStatus.INFO,
					"**************** VERIFY THE MOVE BUTTON IS DISPLAY IN JINESH USER OR NOT ****************");
			Reporter.log("**************** VERIFY THE MOVE BUTTON IS DISPLAY IN JINESH USER OR NOT ****************");
			log.info("**************** VERIFY THE MOVE BUTTON IS DISPLAY IN JINESH USER OR NOT ****************");
			...
			try {
				...
				try {
					...
					// click on the incident report checkbox
					click("ohs_incident_movechecklist_CSS");
					ngDriver.waitForAngularRequestsToFinish();
					System.out.println("Clicked on the incident report checkbox.");

					// wait for the element
					explicitWaitClickable("ohs_incident_movebtn_CSS");

					boolean ss1 = driver.findElement(By.cssSelector(OR.getProperty("ohs_incident_movebtn_CSS")))
							.isDisplayed();

					if (ss1 == true) {

						System.out.println("The Move Button is display as expected.");
						test.log(LogStatus.INFO, "The Move Button is display as expected.");
						Reporter.log("The Move Button is display as expected.");
						log.info("The Move Button is display as expected.");

					} else {
						TestUtil.captureScreenshot();

						// ReportNG
						Reporter.log("<br>" + " The Move Button is not display. : " + "<br>");
						...
						// Extent Report
						test.log(LogStatus.FAIL, " The Move Button is not display. : ");
						test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));

						System.out.println("The Move Button is not display.");
						log.info("The Move Button is not display.");
					}
			...
			System.out.println(
					"**************** VERIFY THE MOVE BUTTON IS DISPLAY IN THE CONTRACTOR ROLE ****************");
			test.log(LogStatus.INFO,
					"**************** VERIFY THE MOVE BUTTON IS DISPLAY IN THE CONTRACTOR ROLE ****************");
			Reporter.log("**************** VERIFY THE MOVE BUTTON IS DISPLAY IN THE CONTRACTOR ROLE ****************");
			log.info("**************** VERIFY THE MOVE BUTTON IS DISPLAY IN THE CONTRACTOR ROLE ****************");
			...
			try {
				...
				try {
					...
					boolean ss2 = driver.findElement(By.cssSelector(OR.getProperty("ohs_incident_movebtn_CSS")))
							.isDisplayed();
			...
			System.out.println("**************** VERIFY THE MOVE BUTTON IS DISPLAY IN THE JINESH HR ****************");
			test.log(LogStatus.INFO,
					"**************** VERIFY THE MOVE BUTTON IS DISPLAY IN THE JINESH HR ****************");
			Reporter.log("**************** VERIFY THE MOVE BUTTON IS DISPLAY IN THE JINESH HR ****************");
			log.info("**************** VERIFY THE MOVE BUTTON IS DISPLAY IN THE JINESH HR ****************");
			...
			try {
				...
				try {
					...
					boolean ss3 = driver.findElement(By.cssSelector(OR.getProperty("ohs_incident_movebtn_CSS")))
							.isDisplayed();
					...
					if (ss3 == true) {
						...
						// ReportNG
						Reporter.log("<br>" + " The Move Button is display without the permission. : " + "<br>");
						Reporter.log("<a target=\"_blank\" href=" + TestUtil.screenshotName + "><img src="
								+ TestUtil.screenshotName + " height=200 width=200></img></a>");
						Reporter.log("<br>");
						Reporter.log("<br>");
						...
						// Extent Report
						test.log(LogStatus.FAIL, " The Move Button is display without the permission. : ");
						test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));

						System.out.println("The Move Button is display without the permission.");
						log.info("The Move Button is display without the permission.");

					} else {
						System.out.println("The Move Button is not display as expected.");
						test.log(LogStatus.INFO, "The Move Button is not display as expected.");
						Reporter.log("The Move Button is not display as expected.");
						log.info("The Move Button is not display as expected.");
					}
		...
		try {
			...
			click("ohs_incident_addedincidentreport55_XPATH");
			ngDriver.waitForAngularRequestsToFinish();
			...
			helper.deleteVerification("ohs_incident_addedincidentreport55_XPATH",
					"Describe Incident Text SS Five Testing Purpose");
		...
		try {
			...
			helper.resetPermission(data, "ohs_security_setting_1", "ohs_securitysettings5_XPATH");

...
public class RR5272OHSSevenTest extends TestBase {
	...
	public void rR5272OHSSevenTest(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		System.out.println("********** ALERT NOTIFICATION - ALERT TYPE: DELETE AND TIME OF DAY: ALL DAY **********");
		test.log(LogStatus.INFO,
				"********** ALERT NOTIFICATION - ALERT TYPE: DELETE AND TIME OF DAY: ALL DAY **********");
		Reporter.log("********** ALERT NOTIFICATION - ALERT TYPE: DELETE AND TIME OF DAY: ALL DAY **********");
		log.info("********** ALERT NOTIFICATION - ALERT TYPE: DELETE AND TIME OF DAY: ALL DAY **********");
		...
		test.log(LogStatus.INFO,
				"********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: DELETE AND TIME OF DAY: ALL DAY **********");
		Reporter.log("********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: DELETE AND TIME OF DAY: ALL DAY **********");
		log.info("********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: DELETE AND TIME OF DAY: ALL DAY **********");

...
public class RR5272OHSOneTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR5272OHSOneTest(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR5272OHSOneTest");

		// ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: ALL DAY

		System.out.println("********** ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: ALL DAY **********");
		test.log(LogStatus.INFO, "********** ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: ALL DAY **********");
		Reporter.log("********** ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: ALL DAY **********");
		log.info("********** ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: ALL DAY **********");
		...
		// ADD NEW ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: ALL DAY

		System.out
				.println("********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: ALL DAY **********");
		test.log(LogStatus.INFO,
				"********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: ALL DAY **********");
		Reporter.log("********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: ALL DAY **********");
		log.info("********** ADD NEW ALERT NOTIFICATION - ALERT TYPE: ADD AND TIME OF DAY: ALL DAY **********");
		...
		try {
			...
			switchVerification("ohs_incident_alertnotification_addedincidentreport1_XPATH",
					"Describe Incident Text Alert Notification One",
					"The Describe Incident Text Alert Notification One is not displayed successfully.");
		...
		try {
			...
			click("ohs_incident_alertnotification_addedincidentreport1_XPATH");
			...
			helper.deleteVerification("ohs_incident_alertnotification_addedincidentreport1_XPATH",
					"Describe Incident Text Alert Notification One");

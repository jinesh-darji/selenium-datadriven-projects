...
public class RR5047OHSTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR5047OHSTest(Hashtable<String, String> data) throws IOException, InterruptedException {
...
//			System.out.println("Selected the reported option from the injury status dropdown.");
		...
		try {
			...
			switchVerification("ohs_incident_addedincidentreport1_XPATH", "Describe Incident Text Testing Purpose",
					"The Describe Incident Text Testing Purpose is not displayed successfully.");
		...
		try {
			...
			switchVerification("ohs_incident_updatedincidentreport1_XPATH",
					"Update Describe Incident Text Testing Purpose",
					"The Update Describe Incident Text Testing Purpose is not displayed successfully.");

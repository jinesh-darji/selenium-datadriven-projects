...
public class RR3900SurveyChecklistFiveTest extends TestBase {
	...
	public void rR3900SurveyChecklistFiveTest(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		System.out.println("CREATE THE CHECKLIST IN PROPERTY AND SELECT THE USER TO CREATE INSTANCE PERMISSION");
		test.log(LogStatus.INFO, "CREATE THE CHECKLIST IN PROPERTY AND SELECT THE USER TO CREATE INSTANCE PERMISSION");
		Reporter.log("CREATE THE CHECKLIST IN PROPERTY AND SELECT THE USER TO CREATE INSTANCE PERMISSION");
		log.info("CREATE THE CHECKLIST IN PROPERTY AND SELECT THE USER TO CREATE INSTANCE PERMISSION");
...
//			ngDriver.waitForAngularRequestsToFinish();
			...
			System.out.println("Clicked on the User to Create Instance field.");
			ngDriver.waitForAngularRequestsToFinish();

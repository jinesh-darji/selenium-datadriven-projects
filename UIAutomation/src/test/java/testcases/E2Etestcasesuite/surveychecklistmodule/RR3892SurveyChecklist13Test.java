...
public class RR3892SurveyChecklist13Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR3892SurveyChecklist13Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR3892SurveyChecklist13Test");
		...
		try {
			...
			verifyTrue("questionnaire_createdrecordauto_13_XPATH", "The newly questionnaire is not created.");

			// CONFIGRATION OF QUESTION
			title("CONFIGRATION OF QUESTION");

			// click on the created questionnaire
			click("questionnaire_createdrecordauto_13_XPATH");
			...
			switchVerification("questionnaire_createdrecordauto_13_XPATH", "Test Auto Questionnaire Thirteen Title",
					"The Test Auto Questionnaire Thirteen Title record is not displayed in the questionnaire list.");
		...
		try {
			...
			try {
				...
				switchVerification("task_createdtask_13_XPATH", "Test Task Thirteen Title",
						"The Test Task Thirteen Title is not displayed.");

				// click on the auto generated task
				click("task_createdtask_13_XPATH");
		...
		try {
			...
			String reopenOption = "//p[text()='" + data.get("task_title")
					+ "']//parent::td[@ng-click='editTaskFromLandingPage(task)']//following-sibling::td[@class='text-center pointer']//ul[@class='dropdown-menu text-left']//a[contains(text(),'Reopen Task')]";
			driver.findElement(By.xpath(reopenOption)).click();
			consoleMessage("Clicked on the action icon");

			// select the active option from the dropdown
			select("survey_task_closefilter_CSS", data.get("activefilter_dd"));
			...
			// click on the action icon
			actionIcon = "//p[text()='" + data.get("task_title")
					+ "']//parent::td[@ng-click='editTaskFromLandingPage(task)']//following-sibling::td[@class='text-center pointer']//i[@data-toggle='dropdown']";
			driver.findElement(By.xpath(actionIcon)).click();
			consoleMessage("Clicked on the action icon");
			...
			String deleteOption = "//p[text()='" + data.get("task_title")
					+ "']//parent::td[@ng-click='editTaskFromLandingPage(task)']//following-sibling::td[@class='text-center pointer']//ul[@class='dropdown-menu text-left']//a[contains(text(),'Delete Task')]";

...
public class RR5306SurveyChecklist5Test extends TestBase {
	...
	public void rR5306SurveyChecklist5Test(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		title("COPY THE QUESTIONNAIRE WITHOUT AN ANSWER, WHERE THE ORIGINAL QUESTIONNAIRE WAS APPROVED WHILE PERFORMING THE SURVEY.");
				...
				if (stringOption.equals(data.get("questionnaire_title"))
					...
					if (stringOption.equals(data.get("questionnaire_title"))) {
						...
						try {
							...
							verificationFailedMessage("The copied questionnaire is display selected.");
						} catch (Throwable t) {
							successMessage("The copied questionnaire is not display selected as expected.");
						}
					}
				}
			}

...
public class RR5306SurveyChecklist5Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR5306SurveyChecklist5Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR5306SurveyChecklist5Test");

		// COPY THE QUESTIONNAIRE WITHOUT AN ANSWER, WHERE THE ORIGINAL QUESTIONNAIRE
		// WAS APPROVED WHILE PERFORMING THE SURVEY.

		System.out.println(
				"COPY THE QUESTIONNAIRE WITHOUT AN ANSWER, WHERE THE ORIGINAL QUESTIONNAIRE WAS APPROVED WHILE PERFORMING THE SURVEY.");
		...
		try {
			...
			switchVerification("questionnaire_createdrecordcopy_5_XPATH", "Test Questionnaire Copy Five Title",
					"The Test Questionnaire Copy Five Title is not displayed.");

			// CONFIGRATION OF QUESTION

			// click on the created questionnaire
			click("questionnaire_createdrecordcopy_5_XPATH");
			...
			switchVerification("questionnaire_createdrecordcopy_5_XPATH", "Test Questionnaire Copy Five Title",
					"The Test Questionnaire Copy Five Title record is not displayed in the questionnaire list.");
		...
		try {
			...
			// verify copied questionnaire is displayed or not
			switchVerification("questionnaire_copiedrecord5_XPATH", "Test Copied Questionnaire Copy Five Title",
					"The copied questionnaire is not displayed.");
		...
		try {
			...
			click("questionnaire_copiedrecord5_XPATH");
			...
			helper.deleteVerification("questionnaire_copiedrecord5_XPATH", "Test Copied Questionnaire Copy Five Title");

...
public class RR3892SurveyChecklistOneTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR3892SurveyChecklistOneTest(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR3892SurveyChecklistOneTest");

		// 1. CREATE THE AUTO GENERATE TASK AND VERIFY ON THE TASK LIST
		// 2. UPDATE THE ANSWER AND VERIFY CREATED TASK IS DELETED OR NOT

		title("1. CREATE THE AUTO GENERATE TASK AND VERIFY ON THE TASK LIST // 2. UPDATE THE ANSWER AND VERIFY CREATED TASK IS DELETED OR NOT.");
		...
		try {
			...
			verifyTrue("questionnaire_createdrecordauto_1_XPATH", "The newly questionnaire is not created.");

			// CONFIGRATION OF QUESTION
			title("CONFIGRATION OF QUESTION");

			// click on the created questionnaire
			click("questionnaire_createdrecordauto_1_XPATH");
			...
			switchVerification("questionnaire_createdrecordauto_1_XPATH", "Test Auto Questionnaire One Title",
					"The Test Auto Questionnaire One Title record is not displayed in the questionnaire list.");
		...
		try {
			...
			switchVerification("task_createdtask_1_XPATH", "Test Task One Title",
					"The Test Task One Title is not displayed.");
		...
		// VERIFY AUTO GENERATED TASK IS REMOVED OR NOT
		title("VERIFY AUTO GENERATED TASK IS REMOVED OR NOT");
		...
		try {
			...
			helper.deleteVerification("task_createdtask_1_XPATH", "Test Task One Title");

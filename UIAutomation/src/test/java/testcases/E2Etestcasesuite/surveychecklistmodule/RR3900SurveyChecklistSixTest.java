...
public class RR3900SurveyChecklistSixTest extends TestBase {
	...
	public void rR3900SurveyChecklistSixTest(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		System.out.println("CREATE THE CHECKLIST IN PROPERTY AND SELECT THE ROLE TO CREATE INSTANCE PERMISSION");
		test.log(LogStatus.INFO, "CREATE THE CHECKLIST IN PROPERTY AND SELECT THE ROLE TO CREATE INSTANCE PERMISSION");
		Reporter.log("CREATE THE CHECKLIST IN PROPERTY AND SELECT THE ROLE TO CREATE INSTANCE PERMISSION");
		log.info("CREATE THE CHECKLIST IN PROPERTY AND SELECT THE ROLE TO CREATE INSTANCE PERMISSION");

...
public class RR5306SurveyChecklist2Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR5306SurveyChecklist2Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR5306SurveyChecklist2Test");

		// COPY THE QUESTIONNAIRE WITHOUT AN ANSWER, WHERE ANSWERS ARE ADDED WHILE
		// PERFORMING THE SURVEY.

		System.out.println(
				"COPY THE QUESTIONNAIRE WITHOUT AN ANSWER, WHERE ANSWERS ARE ADDED WHILE PERFORMING THE SURVEY.");
		test.log(LogStatus.INFO,
				"COPY THE QUESTIONNAIRE WITHOUT AN ANSWER, WHERE ANSWERS ARE ADDED WHILE PERFORMING THE SURVEY.");
		Reporter.log("COPY THE QUESTIONNAIRE WITHOUT AN ANSWER, WHERE ANSWERS ARE ADDED WHILE PERFORMING THE SURVEY.");
		log.info("COPY THE QUESTIONNAIRE WITHOUT AN ANSWER, WHERE ANSWERS ARE ADDED WHILE PERFORMING THE SURVEY.");
		...
		try {
			...
			switchVerification("questionnaire_createdrecordcopy_2_XPATH", "Test Questionnaire Copy Two Title",
					"The Test Questionnaire Copy Two Title is not displayed.");

			// CONFIGRATION OF QUESTION

			// click on the created questionnaire
			click("questionnaire_createdrecordcopy_2_XPATH");
			...
			switchVerification("questionnaire_createdrecordcopy_2_XPATH", "Test Questionnaire Copy Two Title",
					"The Test Questionnaire Copy Two Title record is not displayed in the questionnaire list.");
...
//		driver.navigate().refresh();
		...
		try {
			...
			// verify copied questionnaire is displayed or not
			switchVerification("questionnaire_copiedrecord1_XPATH", "Test Copied Questionnaire Copy Two Title",
					"The copied questionnaire is not displayed.");
			...
			for (int i = 0; i < optionsize; i++) {
				...
				if (stringOption.equals(data.get("questionnaire_title"))
					...
					if (stringOption.equals(data.get("questionnaire_title"))) {
						...
						select("survey_questionnairedd_CSS", stringOption);
						ngDriver.waitForAngularRequestsToFinish();
						System.out.println("Selected the coiped questionnaire from the dropdown.");

						try {
							driver.findElement(By.cssSelector(OR.getProperty("survey_selectedyesanswer_CSS")))
									.isDisplayed();

							TestUtil.captureScreenshot();

							// ReportNG
							Reporter.log("<br>" + "The copied questionnaire is display selected. : " + "<br>");
							Reporter.log("<a target=\"_blank\" href=" + TestUtil.screenshotName + "><img src="
									+ TestUtil.screenshotName + " height=200 width=200></img></a>");
							Reporter.log("<br>");
							Reporter.log("<br>");
							...
							// Extent Report
							test.log(LogStatus.FAIL, " The copied questionnaire is display selected. : ");
							test.log(LogStatus.FAIL, test.addScreenCapture(TestUtil.screenshotName));

							System.out.println("The copied questionnaire is display selected.");
							log.info("The copied questionnaire is display selected.");

						} catch (Throwable t) {

							System.out.println("The copied questionnaire is not display selected as expected.");
							test.log(LogStatus.INFO, "The copied questionnaire is not display selected as expected.");
							Reporter.log("The copied questionnaire is not display selected as expected.");
							log.info("The copied questionnaire is not display selected as expected.");
		...
		try {
			...
			click("questionnaire_copiedrecord1_XPATH");
			...
			helper.deleteVerification("questionnaire_copiedrecord1_XPATH", "Test Copied Questionnaire Copy Two Title");

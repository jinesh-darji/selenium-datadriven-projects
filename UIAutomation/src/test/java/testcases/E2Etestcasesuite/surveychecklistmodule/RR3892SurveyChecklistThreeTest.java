...
public class RR3892SurveyChecklistThreeTest extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR3892SurveyChecklistThreeTest(Hashtable<String, String> data)
			throws IOException, InterruptedException {

		execution(data, "rR3892SurveyChecklistThreeTest");

		// TASKS ASSOCIATED WITH THE DEPENDENT QUESTION SHOULD BE DELETED WHEN ITS
		// PARENT QUESTION IS SWITCHED - The "Pending" task consider as a
		// Inactive task so it should Deleted successfully.

		title("TASKS ASSOCIATED WITH THE DEPENDENT QUESTION SHOULD BE DELETED WHEN ITS PARENT QUESTION IS SWITCHED - The \\\"Pending\\\" task consider as a Inactive task so it should Deleted successfully.");
		...
		try {
			...
			verifyTrue("questionnaire_createdrecordauto_3_XPATH", "The newly questionnaire is not created.");

			// CONFIGRATION OF QUESTION
			title("CONFIGRATION OF QUESTION");

			// click on the created questionnaire
			click("questionnaire_createdrecordauto_3_XPATH");
			...
			switchVerification("questionnaire_createdrecordauto_3_XPATH", "Test Auto Questionnaire Three Title",
					"The Test Auto Questionnaire Three Title record is not displayed in the questionnaire list.");
		...
		try {
			...
			// wait for the element
			explicitWaitClickable("survey_questionnairedd_CSS");
		...
		try {
			...
			switchVerification("task_createdtask_3_XPATH", "Test Task Three Title",
		...
		try {
			...
			helper.deleteVerification("task_createdtask_3_XPATH", "Test Task Three Title");

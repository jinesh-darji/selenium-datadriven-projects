...
public class RR3892SurveyChecklist14Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR3892SurveyChecklist14Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		execution(data, "rR3892SurveyChecklist14Test");
		...
		try {
			...
			verifyTrue("questionnaire_createdrecordauto_14_XPATH", "The newly questionnaire is not created.");

			// CONFIGRATION OF QUESTION
			title("CONFIGRATION OF QUESTION");

			// click on the created questionnaire
			click("questionnaire_createdrecordauto_14_XPATH");
			...
			switchVerification("questionnaire_createdrecordauto_14_XPATH", "Test Auto Questionnaire Fourteen Title",
					"The Test Auto Questionnaire Fourteen Title record is not displayed in the questionnaire list.");
		...
		try {
			...
			try {
				...
				switchVerification("task_createdtask_14_XPATH", "Test Task Fourteen Title",
						"The Test Task Fourteen Title is not displayed.");

				// click on the auto generated task
				click("task_createdtask_14_XPATH");
				...
				switchVerification("task_cancelbtn_filtered_XPATH", "Cancelled",
						"The Cancelled task is not displayed.");

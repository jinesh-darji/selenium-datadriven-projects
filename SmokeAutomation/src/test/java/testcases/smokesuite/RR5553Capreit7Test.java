...
public class RR5553Capreit7Test extends TestBase {
	...
	public void rR5553Capreit7Test(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		if (!(TestUtil.isTestRunnable("rR5553Capreit7Test", excel))) {

			throw new SkipException(
					"Skipping the test " + "rR5553Capreit7Test".toUpperCase() + "as the Run mode is NO");
		}
		...
		System.out.println("UPDATE THE INCIDENT REPORT FROM THE INSURANCE INCIDENT DASHBOARD");
		test.log(LogStatus.INFO, "UPDATE THE INCIDENT REPORT FROM THE INSURANCE INCIDENT DASHBOARD");
		Reporter.log("UPDATE THE INCIDENT REPORT FROM THE INSURANCE INCIDENT DASHBOARD");
		log.info("UPDATE THE INCIDENT REPORT FROM THE INSURANCE INCIDENT DASHBOARD");
...
//			System.out.println("Selected the reported option from the injury status dropdown.");
		...
		System.out.println(
				"********** UPDATE THE DETAILS OF THE NEWLY ADDED INCIDENT REPORT FROM THE INSURANCE DASHBOARD **********");

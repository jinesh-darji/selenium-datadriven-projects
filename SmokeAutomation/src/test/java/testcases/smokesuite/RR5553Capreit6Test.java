...
public class RR5553Capreit6Test extends TestBase {
	...
	public void rR5553Capreit6Test(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		execution(data, "rR5553Capreit6Test");
		...
		title("UPDATE THE INCIDENT REPORT FROM THE HR DASHBOARD");
		...
		title("UPDATE THE DETAILS OF THE NEWLY ADDED INCIDENT REPORT FROM THE HR DASHBOARD");

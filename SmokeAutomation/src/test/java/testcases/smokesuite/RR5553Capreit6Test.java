...
public class RR5553Capreit6Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR5553Capreit6Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		if (!(TestUtil.isTestRunnable("rR5553Capreit6Test", excel))) {

			throw new SkipException(
					"Skipping the test " + "rR5553Capreit6Test".toUpperCase() + "as the Run mode is NO");
		}
		...
		// UPDATE THE INCIDENT REPORT FROM THE HR DASHBOARD

		System.out.println("UPDATE THE INCIDENT REPORT FROM THE HR DASHBOARD");
		test.log(LogStatus.INFO, "UPDATE THE INCIDENT REPORT FROM THE HR DASHBOARD");
		Reporter.log("UPDATE THE INCIDENT REPORT FROM THE HR DASHBOARD");
		log.info("UPDATE THE INCIDENT REPORT FROM THE HR DASHBOARD");
...
//			System.out.println("Selected the reported option from the injury status dropdown.");
		...
		try {
			...
			switchVerification("ohs_incident_addedincidentreport_capreit6_XPATH",
					"Capreit6 Describe Incident Text Testing Purpose",
					"The Capreit6 Describe Incident Text Testing Purpose is not displayed successfully.");
		...
		// UPDATE THE DETAILS OF THE NEWLY ADDED INCIDENT REPORT FROM THE HR DASHBOARD
		...
		Reporter.log(
				"********** UPDATE THE DETAILS OF THE NEWLY ADDED INCIDENT REPORT FROM THE HR DASHBOARD **********");
		log.info("********** UPDATE THE DETAILS OF THE NEWLY ADDED INCIDENT REPORT FROM THE HR DASHBOARD **********");
		...
		try {
			...
			select("dashboard_CSS", data.get("hr_dashboard"));
			ngDriver.waitForAngularRequestsToFinish();
		...
		try {
			...
			// verification of the incident report is added or not
			switchVerification("ohs_incident_updatedincidentreport_capreit6_XPATH",
					"Update Capreit6 Describe Incident Text Testing Purpose",
					"The Update Capreit6 Describe Incident Text Testing Purpose is not displayed successfully.");
		...
		try {
			...
			click("ohs_incident_updatedincidentreport_capreit6_XPATH");
			...
			deleteVerification("ohs_incident_updatedincidentreport_capreit6_XPATH",
					"Update Capreit6 Describe Incident Text Testing Purpose");

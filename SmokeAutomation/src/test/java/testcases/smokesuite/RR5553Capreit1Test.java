...
public class RR5553Capreit1Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR5553Capreit1Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		if (!(TestUtil.isTestRunnable("rR5553Capreit1Test", excel))) {

			throw new SkipException(
					"Skipping the test " + "rR5553Capreit1Test".toUpperCase() + "as the Run mode is NO");
		}
...
//			System.out.println("Selected the reported option from the injury status dropdown.");
		...
		try {
			...
			switchVerification("ohs_incident_addedincidentreport_capreit1_XPATH",
					"Capreit1 Describe Incident Text Testing Purpose",
					"The Capreit1 Describe Incident Text Testing Purpose is not displayed successfully.");
		...
		try {
			...
			click("ohs_incident_addedincidentreport_capreit1_XPATH");
...
//			}
		...
		try {
			...
			// verification of the incident report is added or not
			switchVerification("ohs_incident_updatedincidentreport_capreit1_XPATH",
					"Update Capreit1 Describe Incident Text Testing Purpose",
					"The Update Capreit1 Describe Incident Text Testing Purpose is not displayed successfully.");
		...
		try {
			...
			click("ohs_incident_updatedincidentreport_capreit1_XPATH");
			...
			try {
				...
				deleteVerification("ohs_incident_updatedpersoninvolved_XPATH", "Employee");
			...
			try {
				...
				// verify details are deleted or not
				deleteVerification("ohs_incident_updatedwitness_XPATH", "Witness");
			...
			try {
				...
				// verify details are deleted or not
				deleteVerification("ohs_incident_updatedemergencyservices_XPATH", "Fire");
			...
			try {
				...
				// verify details are deleted or not
				deleteVerification("ohs_incident_updatedpropertydamage_XPATH", "Update Nature Of Damage Test");
			...
			try {
				...
				// click on the delete button of the added insurance
				click("ohs_incident_insurancedeletebtn_XPATH");
				ngDriver.waitForAngularRequestsToFinish();
				System.out.println("Clicked on the delete button of the added property damage.");
			...
			try {
				...
				// verify details are deleted or not
				deleteVerification("ohs_incident_updatedincidentreport_capreit1_XPATH",
						"Update Capreit1 Describe Incident Text Testing Purpose");

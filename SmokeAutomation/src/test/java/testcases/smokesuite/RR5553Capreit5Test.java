...
public class RR5553Capreit5Test extends TestBase {
	...
	public void rR5553Capreit5Test(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		execution(data, "rR5553Capreit5Test");
		...
		title("UPDATE THE INCIDENT REPORT FROM THE EHS DASHBOARD");
		...
		try {
			...
			successMessage("Navigate to the Witnesses Tab.");
		...
		try {
			...
			successMessage("Navigate to the emergency services Tab.");
		...
		try {
			...
			successMessage("Navigate to the insurance Tab.");
		...
		title("UPDATE THE DETAILS OF THE NEWLY ADDED INCIDENT REPORT FROM THE EHS DASHBOARD");

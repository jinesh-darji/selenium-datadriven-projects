...
public class RR5553Capreit3Test extends TestBase {

	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void rR5553Capreit3Test(Hashtable<String, String> data) throws IOException, InterruptedException {

		if (!(TestUtil.isTestRunnable("rR5553Capreit3Test", excel))) {

			throw new SkipException(
					"Skipping the test " + "rR5553Capreit3Test".toUpperCase() + "as the Run mode is NO");
		}
		...
		// VERIFY INCIDENT REPORT ON OHS ADMIN USER ACCOUNT

		System.out.println("********** VERIFY INCIDENT REPORT ON OHS ADMIN USER ACCOUNT **********");
		test.log(LogStatus.INFO, "********** VERIFY INCIDENT REPORT ON OHS ADMIN USER ACCOUNT **********");
		Reporter.log("********** VERIFY INCIDENT REPORT ON OHS ADMIN USER ACCOUNT **********");
		log.info("********** VERIFY INCIDENT REPORT ON OHS ADMIN USER ACCOUNT **********");
		...
		// CREATE NEW OHS INCIDENTS - CAPREIT

		System.out.println("******************** CREATE NEW OHS INCIDENTS - CAPREIT ********************");
		test.log(LogStatus.INFO, "******************** CREATE NEW OHS INCIDENTS - CAPREIT ********************");
		Reporter.log("******************** CREATE NEW OHS INCIDENTS - CAPREIT ********************");
		log.info("******************** CREATE NEW OHS INCIDENTS - CAPREIT ********************");
		...
		try {
			...
			switchVerification("ohs_incident_addedincidentreport_capreit3_XPATH",
					"Capreit3 Describe Incident Text Testing Purpose",
					"The Capreit3 Describe Incident Text Testing Purpose is not displayed successfully.");
		...
		try {
			...
			try {
				...
				if (shotDescriptionText.equals("Capreit3 Describe Incident Text Testing Purpose")) {
		...
		try {
			...
			click("ohs_incident_addedincidentreport_capreit3_XPATH");
			...
			deleteVerification("ohs_incident_addedincidentreport_capreit3_XPATH",
					"Capreit3 Describe Incident Text Testing Purpose");

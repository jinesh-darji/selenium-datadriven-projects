...
public class RR5368Capreit3Test extends TestBase {
	...
	public void rR5368Capreit3Test(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		execution(data, "rR5368Capreit3Test");
		...
		title("PERFORM THE TEST CASES OF THE CAPREIT - OPERATION MANAGER");
		...
		try {
			...
			// OPERATION MANAGER
			title("CREATE THE NEW INSPECTION AND CHECKLIST (PROPERTY WITHOUT BUILDING) - OPERATION MANAGER");
			...
			title("SUBMIT THE COVID 19 INSPECTION - OPERATION MANAGER");
			...
			// MANAGER
			title("VERIFY AUTO GENERATED TASK IS DISPLAYED WITH CORRECT DETAILS - OPERATION MANAGER");
			...
			title("VERIFY AUTO GENERATED TASK IS DISPLAYED OR NOT - OPRATION MANAGER USER");
			...
			title("ADD COMMENT IN THE NEWLY CREATED TASK - OPERATION MANAGER");
			...
			title("LOGOUT FROM OPERATION MANAGER USER");
			...
			try {
				...
				title("VERIFY ADDED COMMENT IS DISPLAYED OR NOT");
			...
			title("COMPLETE THE AUTO GENERATED TASK - OPERATION MANAGER USER");
			...
			title("DELETE THE LINKED TASKS - OPERATION MANAGER USER");
			...
			// DELETE THE INSTANCE - OPERATION MANAGER USER
			title("DELETE THE INSTANCE - OPERATION MANAGER USER");

...
public class RR5490Capreit2Test extends TestBase {
	...
	public void rR5490Capreit2Test(Hashtable<String, String> data) throws IOException, InterruptedException {
		...
		execution(data, "rR5490Capreit2Test");
		...
		title("CAPREIT : TEST SCENARIOS RELATED TO THE ENVIRONMENTAL (TASK AND EXCLUDED PROPERTY) - DOCUMENT MANAGEMENT");
		...
		title("ADD TASK IN THE NEWLY CREATED ENVIRONMENTAL REPORT - SUPER ADMIN USER");
		...
		title("VERIFY ENVIRONMENTAL CARD ON THE PORTFOLIO SUMMARY DASHBOARD SCREEN AFTER CREATING THE NEW ENVIRONMENTAL REPORT AND TASK - SUPER ADMIN USER");
		...
		// SUPER ADMIN USER
		title("VERIFY ENVIRONMENTAL CARD ON THE ASSESSMENTS/INSPECTIONS DASHBOARD OF THE ENVIRONMENTAL MODULE AFTER CREATING THE NEW ENVIRONMENTAL REPORT AND TASK - SUPER ADMIN USER");
		...
		// USER
		title("EXCLUDE THE PROPERTY FOR THE NEWLY CREATED ENVIRONMENTAL REPORT - SUPER ADMIN USER");
		...
		try {
			...
			try {
				...
				// scroll the screen
				scrollTillElement("portfolio_environmental_dropdownlist_notrequiredckbx_CSS");
				...
				try {
					...
					if (deleteElement.equals("CAPREIT - White Frost")) {
						...
						verificationFailedMessage("The CAPREIT - White Frost is displayed.");
					}
				} catch (Throwable t) {
					successMessage("The CAPREIT - White Frost is deleted successfully.");
				}
		...
		title("VERIFY ENVIRONMENTAL CARD ON THE PORTFOLIO SUMMARY DASHBOARD SCREEN AFTER EXCLUDED THE PROPERTY - SUPER ADMIN USER");
		...
		title("VERIFY ENVIRONMENTAL CARD ON THE ASSESSMENTS/INSPECTIONS DASHBOARD OF THE ENVIRONMENTAL MODULE AFTER EXCLUDING THE PROPERTY - SUPER ADMIN USER");
		...
		title("DELETE THE TASK - SUPER ADMIN USER");
